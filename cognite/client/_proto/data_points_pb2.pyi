...
class StateAggregateDatapoint(_message.Message):
    __slots__ = ("timestamp", "count", "countGood", "countUncertain", "countBad", "durationGood", "durationUncertain", "durationBad", "interpolation", "stepInterpolation", "stateAggregates")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    COUNTGOOD_FIELD_NUMBER: _ClassVar[int]
    COUNTUNCERTAIN_FIELD_NUMBER: _ClassVar[int]
    ...
    durationUncertain: float
    durationBad: float
    interpolation: StateDatapointValue
    stepInterpolation: StateDatapointValue
    stateAggregates: _containers.RepeatedCompositeFieldContainer[StateAggregate]
    def __init__(self, timestamp: _Optional[int] = ..., count: _Optional[float] = ..., countGood: _Optional[float] = ..., countUncertain: _Optional[float] = ..., countBad: _Optional[float] = ..., durationGood: _Optional[float] = ..., durationUncertain: _Optional[float] = ..., durationBad: _Optional[float] = ..., interpolation: _Optional[_Union[StateDatapointValue, _Mapping]] = ..., stepInterpolation: _Optional[_Union[StateDatapointValue, _Mapping]] = ..., stateAggregates: _Optional[_Iterable[_Union[StateAggregate, _Mapping]]] = ...) -> None: ...

class StateDatapointValue(_message.Message):
    __slots__ = ("numericValue", "stringValue")
    NUMERICVALUE_FIELD_NUMBER: _ClassVar[int]
    STRINGVALUE_FIELD_NUMBER: _ClassVar[int]
    numericValue: int
    stringValue: str
    def __init__(self, numericValue: _Optional[int] = ..., stringValue: _Optional[str] = ...) -> None: ...

class StateAggregateDatapoints(_message.Message):
    __slots__ = ("datapoints",)
    DATAPOINTS_FIELD_NUMBER: _ClassVar[int]
    datapoints: _containers.RepeatedCompositeFieldContainer[StateAggregateDatapoint]
    def __init__(self, datapoints: _Optional[_Iterable[_Union[StateAggregateDatapoint, _Mapping]]] = ...) -> None: ...
