...
class DataPointListItem(_message.Message):
    __slots__ = ("id", "externalId", "instanceId", "isString", "isStep", "unit", "nextCursor", "unitExternalId", "type", "numericDatapoints", "stringDatapoints", "aggregateDatapoints", "stateAggregateDatapoints", "stateDatapoints")
    ...
    STATEAGGREGATEDATAPOINTS_FIELD_NUMBER: _ClassVar[int]
