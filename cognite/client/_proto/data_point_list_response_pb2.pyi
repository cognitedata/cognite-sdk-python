...
class DataPointListItem(_message.Message):
    __slots__ = ["aggregateDatapoints", "externalId", "id", "isStep", "isString", "numericDatapoints", "stringDatapoints", "unit"]
