...
class TimeSeriesAPI(APIClient):
    ...
    def retrieve(self, id: Optional[int] = None, external_id: Optional[str] = None) -> Optional[TimeSeries]:
        """`Retrieve a single time series by id. <https://api-docs.cognite.com/v1/tag/Time-series/operation/getTimeSeriesByIds>`_
    ...
    def retrieve_multiple(
        ...
        """`Retrieve multiple time series by id. <https://api-docs.cognite.com/v1/tag/Time-series/operation/getTimeSeriesByIds>`_
    ...
    def list(
        ...
        """`List over time series <https://api-docs.cognite.com/v1/tag/Time-series/operation/listTimeSeries>`_
    ...
    def aggregate(self, filter: Union[TimeSeriesFilter, Dict] = None) -> List[TimeSeriesAggregate]:
        """`Aggregate time series <https://api-docs.cognite.com/v1/tag/Time-series/operation/aggregateTimeSeries>`_
    ...
    def create(self, time_series: Union[TimeSeries, Sequence[TimeSeries]]) -> Union[TimeSeries, TimeSeriesList]:
        """`Create one or more time series. <https://api-docs.cognite.com/v1/tag/Time-series/operation/postTimeSeries>`_
    ...
    def delete(
        ...
        """`Delete one or more time series. <https://api-docs.cognite.com/v1/tag/Time-series/operation/deleteTimeSeries>`_
    ...
    def update(
        ...
        """`Update one or more time series. <https://api-docs.cognite.com/v1/tag/Time-series/operation/alterTimeSeries>`_
    ...
    def search(
        ...
        """`Search for time series. <https://api-docs.cognite.com/v1/tag/Time-series/operation/searchTimeSeries>`_
