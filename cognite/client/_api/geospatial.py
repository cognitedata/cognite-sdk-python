...
class GeospatialAPI(APIClient):
    ...
    def create_feature_types(
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/createFeatureTypes>
    ...
    def delete_feature_types(self, external_id: Union[str, Sequence[str]], recursive: bool = False) -> None:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/GeospatialDeleteFeatureTypes>
    ...
    def list_feature_types(self) -> FeatureTypeList:
        """`List feature types`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/listFeatureTypes>
    ...
    def retrieve_feature_types(self, external_id: Union[str, List[str]]) -> Union[FeatureType, FeatureTypeList]:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/getFeatureTypesByIds>
    ...
    def update_feature_types(self, update: Union[FeatureTypeUpdate, Sequence[FeatureTypeUpdate]]) -> FeatureTypeList:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/updateFeatureTypes>
    ...
    def create_features(
        ...
        """`Creates features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/createFeatures>
    ...
    def delete_features(self, feature_type_external_id: str, external_id: Union[str, Sequence[str]] = None) -> None:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/deleteFeatures>
    ...
    def retrieve_features(
        ...
        """`Retrieve features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/getFeaturesByIds>
    ...
    def update_features(
        ...
        """`Update features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/updateFeatures>
    ...
    def list_features(
        ...
        """`List features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/listFeatures>
    ...
    def search_features(
        ...
        """`Search for features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/searchFeatures>
    ...
    def stream_features(
        ...
        """`Stream features`
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/searchFeaturesStreaming>
    ...
    def aggregate_features(
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/aggregateFeatures>
    ...
    def get_coordinate_reference_systems(self, srids: Union[int, Sequence[int]]) -> CoordinateReferenceSystemList:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/getCoordinateReferenceSystem>
    ...
    def list_coordinate_reference_systems(self, only_custom: bool = False) -> CoordinateReferenceSystemList:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/listGeospatialCoordinateReferenceSystems>
    ...
    def create_coordinate_reference_systems(
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/createGeospatialCoordinateReferenceSystems>
    ...
    def delete_coordinate_reference_systems(self, srids: Union[int, Sequence[int]]) -> None:
        ...
        <https://api-docs.cognite.com/v1/tag/Geospatial/operation/deleteGeospatialCoordinateReferenceSystems>
    ...
    def put_raster(
        ...
        """`Put raster <https://api-docs.cognite.com/v1/tag/Geospatial/operation/putRaster>`
    ...
    def delete_raster(
        ...
        """`Delete raster <https://api-docs.cognite.com/v1/tag/Geospatial/operation/deleteRaster>`
    ...
    def get_raster(
        ...
        """`Get raster <https://api-docs.cognite.com/v1/tag/Geospatial/operation/getRaster>`
    ...
    def compute(
        ...
        """`Compute <https://api-docs.cognite.com/v1/tag/Geospatial/operation/compute>`
