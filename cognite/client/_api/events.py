...
class EventsAPI(APIClient):
    ...
    def __call__(
        ...
        Args:
            ...
            sort (List[str]): Sort by array of selected fields. Ex: ["startTime:desc']. Default sort order is asc with short syntax: field_name. Filter accepts following field names: startTime, endTime, createdTime, lastUpdatedTime. We only support 1 field for now.
