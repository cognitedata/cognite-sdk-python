...
class DataSetsAPI(APIClient):
    ...
    def create(self, data_set: Union[DataSet, Sequence[DataSet]]) -> Union[DataSet, DataSetList]:
        """`Create one or more data sets. <https://api-docs.cognite.com/v1/tag/Data-sets/operation/createDataSets>`_
    ...
    def retrieve(self, id: Optional[int] = None, external_id: Optional[str] = None) -> Optional[DataSet]:
        """`Retrieve a single data set by id. <https://api-docs.cognite.com/v1/tag/Data-sets/operation/getDataSets>`_
    ...
    def retrieve_multiple(
        ...
        """`Retrieve multiple data sets by id. <https://api-docs.cognite.com/v1/tag/Data-sets/operation/getDataSets>`_
    ...
    def list(
        ...
        """`List data sets <https://api-docs.cognite.com/v1/tag/Data-sets/operation/listDataSets>`_
    ...
    def aggregate(self, filter: Union[DataSetFilter, Dict] = None) -> List[DataSetAggregate]:
        """`Aggregate data sets <https://api-docs.cognite.com/v1/tag/Data-sets/operation/aggregateDataSets>`_
    ...
    def update(
        ...
        """`Update one or more data sets <https://api-docs.cognite.com/v1/tag/Data-sets/operation/updateDataSets>`_
