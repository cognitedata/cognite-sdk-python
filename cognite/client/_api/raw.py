...
class RawDatabasesAPI(APIClient):
    ...
    def create(self, name: Union[str, List[str]]) -> Union[Database, DatabaseList]:
        """`Create one or more databases. <https://api-docs.cognite.com/v1/tag/Raw/operation/createDBs>`_
    ...
    def delete(self, name: Union[str, Sequence[str]], recursive: bool = False) -> None:
        """`Delete one or more databases. <https://api-docs.cognite.com/v1/tag/Raw/operation/deleteDBs>`_
    ...
    def list(self, limit: int = LIST_LIMIT_DEFAULT) -> DatabaseList:
        """`List databases <https://api-docs.cognite.com/v1/tag/Raw/operation/getDBs>`_
...
class RawTablesAPI(APIClient):
    ...
    def create(self, db_name: str, name: Union[str, List[str]]) -> Union[Table, TableList]:
        """`Create one or more tables. <https://api-docs.cognite.com/v1/tag/Raw/operation/createTables>`_
    ...
    def delete(self, db_name: str, name: Union[str, Sequence[str]]) -> None:
        """`Delete one or more tables. <https://api-docs.cognite.com/v1/tag/Raw/operation/deleteTables>`_
    ...
    def list(self, db_name: str, limit: int = LIST_LIMIT_DEFAULT) -> TableList:
        """`List tables <https://api-docs.cognite.com/v1/tag/Raw/operation/getTables>`_
...
class RawRowsAPI(APIClient):
    ...
    def insert(
        ...
        """`Insert one or more rows into a table. <https://api-docs.cognite.com/v1/tag/Raw/operation/postRows>`_
    ...
    def insert_dataframe(self, db_name: str, table_name: str, dataframe: Any, ensure_parent: bool = False) -> None:
        """`Insert pandas dataframe into a table <https://api-docs.cognite.com/v1/tag/Raw/operation/postRows>`_
    ...
    def delete(self, db_name: str, table_name: str, key: Union[str, Sequence[str]]) -> None:
        """`Delete rows from a table. <https://api-docs.cognite.com/v1/tag/Raw/operation/deleteRows>`_
    ...
    def retrieve(self, db_name: str, table_name: str, key: str) -> Optional[Row]:
        """`Retrieve a single row by key. <https://api-docs.cognite.com/v1/tag/Raw/operation/getRow>`_
    ...
    def list(
        ...
        """`List rows in a table. <https://api-docs.cognite.com/v1/tag/Raw/operation/getRows>`_
    ...
    def retrieve_dataframe(
        ...
        """`Retrieve rows in a table as a pandas dataframe. <https://api-docs.cognite.com/v1/tag/Raw/operation/getRows>`_
