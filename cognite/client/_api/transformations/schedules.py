...
class TransformationSchedulesAPI(APIClient):
    ...
    def create(
        ...
        """`Schedule the specified transformation with the specified configuration(s). <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/createTransformationSchedules>`_
    ...
    def retrieve(self, id: Optional[int] = None, external_id: Optional[str] = None) -> Optional[TransformationSchedule]:
        """`Retrieve a single transformation schedule by the id or external id of its transformation. <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/getTransformationSchedulesByIds>`_
    ...
    def retrieve_multiple(
        ...
        """`Retrieve multiple transformation schedules by the ids or external ids of the corresponding transformations. <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/getTransformationSchedulesByIds>`_
    ...
    def list(
        ...
        """`List all transformation schedules. <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/getTransformationSchedules>`_
    ...
    def delete(
        ...
        """`Unschedule one or more transformations <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/deleteTransformationSchedules>`_
    ...
    def update(
        ...
        """`Update one or more transformation schedules <https://api-docs.cognite.com/v1/tag/Transformation-Schedules/operation/updateTransformationSchedules>`_
