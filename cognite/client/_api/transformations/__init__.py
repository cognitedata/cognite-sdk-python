...
class TransformationsAPI(APIClient):
    ...
    def create(
        ...
        """`Create one or more transformations. <https://api-docs.cognite.com/v1/tag/Transformations/operation/createTransformations>`_
    ...
    def delete(
        ...
        """`Delete one or more transformations. <https://api-docs.cognite.com/v1/tag/Transformations/operation/deleteTransformations>`_
    ...
    def list(
        ...
        """`List all transformations. <https://api-docs.cognite.com/v1/tag/Transformations/operation/getTransformations>`_
    ...
    def retrieve(self, id: Optional[int] = None, external_id: Optional[str] = None) -> Optional[Transformation]:
        """`Retrieve a single transformation by id. <https://api-docs.cognite.com/v1/tag/Transformations/operation/getTransformationsByIds>`_
    ...
    def retrieve_multiple(
        ...
        """`Retrieve multiple transformations. <https://api-docs.cognite.com/v1/tag/Transformations/operation/getTransformationsByIds>`_
    ...
    def update(
        ...
        """`Update one or more transformations <https://api-docs.cognite.com/v1/tag/Transformations/operation/updateTransformations>`_
    ...
    def run(
        ...
        """`Run a transformation. <https://api-docs.cognite.com/v1/tag/Transformations/operation/runTransformation>`_
    ...
    async def run_async(
        ...
        """`Run a transformation to completion asynchronously. <https://api-docs.cognite.com/v1/tag/Transformations/operation/runTransformation>`_
    ...
    def cancel(self, transformation_id: int = None, transformation_external_id: str = None) -> None:
        """`Cancel a running transformation. <https://api-docs.cognite.com/v1/tag/Transformations/operation/cancelTransformation>`_
    ...
    def preview(
        ...
        """`Preview the result of a query. <https://api-docs.cognite.com/v1/tag/Transformations/operation/runPreview>`_
