...
DatapointsId = Union[None, int, Dict[str, Any], typing.Sequence[Union[int, Dict[str, Any]]]]
DatapointsExternalId = Union[None, str, Dict[str, Any], typing.Sequence[Union[str, Dict[str, Any]]]]
