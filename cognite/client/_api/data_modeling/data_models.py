...
class DataModelsAPI(APIClient):
    ...
    def retrieve(self, ids: DataModelIdentifier | Sequence[DataModelIdentifier]) -> DataModelList:
        """`Retrieve data_model(s) by id(s). <https://api-docs.cognite.com/v1/tag/Data-models/operation/byExternalIdsDataModels>`_
    ...
    def delete(self, ids: DataModelIdentifier | Sequence[DataModelIdentifier]) -> list[DataModelId]:
        """`Delete one or more data model <https://api-docs.cognite.com/v1/tag/Data-models/operation/deleteDataModels>`_
    ...
    def list(
        ...
        """`List data models <https://api-docs.cognite.com/v1/tag/Data-models/operation/listDataModels>`_
    ...
    def apply(self, data_model: DataModelApply | Sequence[DataModelApply]) -> DataModel | DataModelList:
        """`Create or update one or more data model. <https://api-docs.cognite.com/v1/tag/Data-models/operation/createDataModels>`_
