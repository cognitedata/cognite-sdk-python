...
class SpacesAPI(APIClient):
    ...
    def retrieve(self, space: str | Sequence[str]) -> Space | SpaceList | None:
        """`Retrieve space by id. <https://api-docs.cognite.com/v1/tag/Spaces/operation/bySpaceIdsSpaces>`_
    ...
    def delete(self, space: str | Sequence[str]) -> list[str]:
        """`Delete one or more spaces <https://api-docs.cognite.com/v1/tag/Spaces/operation/deleteSpacesV3>`_
    ...
    def list(
        ...
        """`List spaces <https://api-docs.cognite.com/v1/tag/Spaces/operation/listSpacesV3>`_
    ...
    def apply(self, space: SpaceApply | Sequence[SpaceApply]) -> Space | SpaceList:
        """`Create or patch one or more spaces. <https://api-docs.cognite.com/v1/tag/Spaces/operation/ApplySpaces>`_
