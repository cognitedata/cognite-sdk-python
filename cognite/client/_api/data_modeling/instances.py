...
class _TypedNodeOrEdgeListAdapter:
    ...
    async def __call__(self, items: Any, cognite_client: AsyncCogniteClient | None = None) -> Any:
...
class InstancesAPI(APIClient):
    ...
    async def __call__(
        ...
        Yields:
            Edge | EdgeList | Node | NodeList: No description.
        Returns:
            AsyncIterator[Edge | EdgeList | Node | NodeList]: yields Instance one by one if chunk_size is not specified, else NodeList/EdgeList objects.
        """
    ...
    async def query(self, query: Query, include_typing: bool = False, debug: DebugParameters | None = None) -> QueryResult:
    ...
    async def sync(self, query: Query, include_typing: bool = False, debug: DebugParameters | None = None) -> QueryResult:
