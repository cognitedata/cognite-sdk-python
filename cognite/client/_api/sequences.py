...
class SequencesAPI(APIClient):
    ...
    def __call__(
        ...
        asset_subtree_external_ids: str | typing.SequenceNotStr[str] | None = None,
        data_set_ids: int | typing.Sequence[int] | None = None,
        data_set_external_ids: str | typing.SequenceNotStr[str] | None = None,
        ...
        Args:
            ...
            asset_subtree_external_ids (str | typing.SequenceNotStr[str] | None): Asset subtree external id or list of asset subtree external ids to filter on.
            data_set_ids (int | typing.Sequence[int] | None): Return only sequences in the specified data set(s) with this id / these ids.
            data_set_external_ids (str | typing.SequenceNotStr[str] | None): Return only sequences in the specified data set(s) with this external id / these external ids.
    ...
    def retrieve_multiple(
        ...
        external_ids: typing.SequenceNotStr[str] | None = None,
        ...
        Args:
            ...
            external_ids (typing.SequenceNotStr[str] | None): External IDs
    ...
    def delete(
        ...
        external_id: str | typing.SequenceNotStr[str] | None = None,
        ignore_unknown_ids: bool = False,
    ) -> None:
        ...
        Args:
            ...
            external_id (str | typing.SequenceNotStr[str] | None): External ID or list of external ids
            ignore_unknown_ids (bool): Ignore IDs and external IDs that are not found rather than throw an exception.
