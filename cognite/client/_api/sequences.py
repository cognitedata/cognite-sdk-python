...
class SequencesAPI(APIClient):
    ...
    def retrieve(self, id: Optional[int] = None, external_id: Optional[str] = None) -> Optional[Sequence]:
        """`Retrieve a single sequence by id. <https://api-docs.cognite.com/v1/tag/Sequences/operation/getSequenceById>`_
    ...
    def retrieve_multiple(
        ...
        """`Retrieve multiple sequences by id. <https://api-docs.cognite.com/v1/tag/Sequences/operation/getSequenceById>`_
    ...
    def list(
        ...
        """`Iterate over sequences <https://api-docs.cognite.com/v1/tag/Sequences/operation/advancedListSequences>`_
    ...
    def aggregate(self, filter: Union[SequenceFilter, Dict] = None) -> List[SequenceAggregate]:
        """`Aggregate sequences <https://api-docs.cognite.com/v1/tag/Sequences/operation/aggregateSequences>`_
    ...
    def create(self, sequence: Union[Sequence, SequenceType[Sequence]]) -> Union[Sequence, SequenceList]:
        """`Create one or more sequences. <https://api-docs.cognite.com/v1/tag/Sequences/operation/createSequence>`_
    ...
    def delete(
        ...
        """`Delete one or more sequences. <https://api-docs.cognite.com/v1/tag/Sequences/operation/deleteSequences>`_
    ...
    def update(
        ...
        """`Update one or more sequences. <https://api-docs.cognite.com/v1/tag/Sequences/operation/updateSequences>`_
    ...
    def search(
        ...
        """`Search for sequences. <https://api-docs.cognite.com/v1/tag/Sequences/operation/searchSequences>`_
...
class SequencesDataAPI(APIClient):
    ...
    def insert(
        ...
        """`Insert rows into a sequence <https://api-docs.cognite.com/v1/tag/Sequences/operation/postSequenceData>`_
    ...
    def insert_dataframe(self, dataframe: pandas.DataFrame, id: int = None, external_id: str = None) -> None:
        """`Insert a Pandas dataframe. <https://api-docs.cognite.com/v1/tag/Sequences/operation/postSequenceData>`_
    ...
    def delete(self, rows: SequenceType[int], id: int = None, external_id: str = None) -> None:
        """`Delete rows from a sequence <https://api-docs.cognite.com/v1/tag/Sequences/operation/deleteSequenceData>`_
    ...
    def delete_range(self, start: int, end: Union[int, None], id: int = None, external_id: str = None) -> None:
        """`Delete a range of rows from a sequence. Note this operation is potentially slow, as retrieves each row before deleting. <https://api-docs.cognite.com/v1/tag/Sequences/operation/deleteSequenceData>`_
    ...
    def retrieve(
        ...
        """`Retrieve data from a sequence <https://api-docs.cognite.com/v1/tag/Sequences/operation/getSequenceData>`_
    ...
    def retrieve_latest(
        ...
        """`Retrieves the last row (i.e the row with the highest row number) in a sequence. <https://api-docs.cognite.com/v1/tag/Sequences/operation/getLatestSequenceRow>`_
    ...
    def retrieve_dataframe(
        ...
        """`Retrieve data from a sequence as a pandas dataframe <https://api-docs.cognite.com/v1/tag/Sequences/operation/getSequenceData>`_
