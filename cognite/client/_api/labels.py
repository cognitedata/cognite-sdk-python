...
class LabelsAPI(APIClient):
    ...
    def list(
        ...
        """`List Labels <https://api-docs.cognite.com/v1/tag/Labels/operation/listLabels>`_
    ...
    def create(
        ...
        """`Create one or more label definitions. <https://api-docs.cognite.com/v1/tag/Labels/operation/createLabelDefinitions>`_
    ...
    def delete(self, external_id: Union[str, Sequence[str]] = None) -> None:
        """`Delete one or more label definitions <https://api-docs.cognite.com/v1/tag/Labels/operation/deleteLabels>`_
