...
class LabelsAPI(APIClient):
    ...
    def list(
        ...
        Args:
            ...
            data_set_ids (List[int]): filter label definitions in the specified data sets with these ids.
            data_set_external_ids (List[str]): filter label definitions in the specified data sets with these external ids.
