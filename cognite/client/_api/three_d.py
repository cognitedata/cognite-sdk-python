...
class ThreeDModelsAPI(APIClient):
    ...
    def list(self, published: bool | None = None, limit: int | None = LIST_LIMIT_DEFAULT) -> ThreeDModelList:
...
class ThreeDRevisionsAPI(APIClient):
    ...
    def list(
        self, model_id: int, published: bool = False, limit: int | None = LIST_LIMIT_DEFAULT
    ) -> ThreeDModelRevisionList:
    ...
    def list_nodes(
        ...
        Args:
            ...
            limit (int | None): Maximun number of nodes to return. Defaults to 25. Set to -1, float("inf") or None to return all items.
    ...
    def list_ancestor_nodes(
        self, model_id: int, revision_id: int, node_id: int | None = None, limit: int | None = LIST_LIMIT_DEFAULT
    ) -> ThreeDNodeList:
