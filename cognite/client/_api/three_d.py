...
class ThreeDModelsAPI(APIClient):
    ...
    def retrieve(self, id: int) -> Optional[ThreeDModel]:
        """`Retrieve a 3d model by id <https://api-docs.cognite.com/v1/tag/3D-Models/operation/get3DModel>`_
    ...
    def list(self, published: bool = None, limit: int = LIST_LIMIT_DEFAULT) -> ThreeDModelList:
        """`List 3d models. <https://api-docs.cognite.com/v1/tag/3D-Models/operation/get3DModels>`_
    ...
    def create(self, name: Union[str, Sequence[str]]) -> Union[ThreeDModel, ThreeDModelList]:
        """`Create new 3d models. <https://api-docs.cognite.com/v1/tag/3D-Models/operation/create3DModels>`_
    ...
    def update(
        ...
        """`Update 3d models. <https://api-docs.cognite.com/v1/tag/3D-Models/operation/update3DModels>`_
    ...
    def delete(self, id: Union[int, Sequence[int]]) -> None:
        """`Delete 3d models. <https://api-docs.cognite.com/v1/tag/3D-Models/operation/delete3DModels>`_
...
class ThreeDRevisionsAPI(APIClient):
    ...
    def retrieve(self, model_id: int, id: int) -> Optional[ThreeDModelRevision]:
        """`Retrieve a 3d model revision by id <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/get3DRevision>`_
    ...
    def create(
        ...
        """`Create a revisions for a specified 3d model. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/create3DRevisions>`_
    ...
    def list(self, model_id: int, published: bool = False, limit: int = LIST_LIMIT_DEFAULT) -> ThreeDModelRevisionList:
        """`List 3d model revisions. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/get3DRevisions>`_
    ...
    def update(
        ...
        """`Update 3d model revisions. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/update3DRevisions>`_
    ...
    def delete(self, model_id: int, id: Union[int, Sequence[int]]) -> None:
        """`Delete 3d model revisions. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/delete3DRevisions>`_
    ...
    def update_thumbnail(self, model_id: int, revision_id: int, file_id: int) -> None:
        """`Update a revision thumbnail. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/updateThumbnail>`_
    ...
    def list_nodes(
        ...
        """`Retrieves a list of nodes from the hierarchy in the 3D Model. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/get3DNodes>`_
    ...
    def filter_nodes(
        ...
        """`List nodes in a revision, filtered by node property values. <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/filter3DNodes>`_
    ...
    def list_ancestor_nodes(
        ...
        """`Retrieves a list of ancestor nodes of a given node, including itself, in the hierarchy of the 3D model <https://api-docs.cognite.com/v1/tag/3D-Model-Revisions/operation/get3DNodeAncestors>`_
...
class ThreeDFilesAPI(APIClient):
    ...
    def retrieve(self, id: int) -> bytes:
        """`Retrieve the contents of a 3d file by id. <https://api-docs.cognite.com/v1/tag/3D-Files/operation/get3DFile>`_
...
class ThreeDAssetMappingAPI(APIClient):
    ...
    def list(
        ...
        """`List 3D node asset mappings. <https://api-docs.cognite.com/v1/tag/3D-Asset-Mapping/operation/get3DMappings>`_
    ...
    def create(
        ...
        """`Create 3d node asset mappings. <https://api-docs.cognite.com/v1/tag/3D-Asset-Mapping/operation/create3DMappings>`_
    ...
    def delete(
        ...
        """`Delete 3d node asset mappings. <https://api-docs.cognite.com/v1/tag/3D-Asset-Mapping/operation/delete3DMappings>`_
