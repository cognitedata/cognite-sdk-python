...
class ThreeDModelsAPI(APIClient):
    ...
    def create(self, name: Union[str, Sequence[str]]) -> Union[ThreeDModel, ThreeDModelList]:
        """`Create one or more new 3D models <https://developer.cognite.com/api#tag/3D-Models/operation/create3DModels>`_.
    ...
    def update(
        ...
        """`Update one or more 3D models <https://developer.cognite.com/api#tag/3D-Models/operation/update3DModels>`_.
    ...
    def delete(self, id: Union[int, Sequence[int]]) -> None:
        """`Delete one or more 3D models <https://developer.cognite.com/api#tag/3D-Models/operation/delete3DModels>`_.
...
class ThreeDAssetMappingAPI(APIClient):
    ...
    def create(
        ...
        """`Create one or more 3D node asset mappings <https://developer.cognite.com/api#tag/3D-Asset-Mapping/operation/create3DMappings>`_.
