...
class FunctionsAPI(APIClient):
    ...
    def create(
        ...
        Args:
            ...
            memory (Number | None): Memory per function measured in GB. Allowed range and default are given in the `limits endpoint. <https://api-docs.cognite.com/20230101/tag/Functions/operation/functionsLimits>`_, and None translates to the API default. On Azure, only the default value is used.
