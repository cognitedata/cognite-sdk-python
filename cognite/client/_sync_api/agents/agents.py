"""
===============================================================================
9ddf9349d41e3d704738c280cb5ffc3c
...
class SyncAgentsAPI:
    ...
    def upsert(self, agents: AgentUpsert | Sequence[AgentUpsert]) -> Agent | AgentList:
        ...
        Examples:
            ...
            Create an agent with multiple different tools:
                ...
                >>> client.agents.upsert(agents=[agent])
        """
        return self._run_sync(self.__async_client.agents.upsert(agents=agents))
    ...
    def list(self) -> AgentList:
        ...
        """
        return self._run_sync(self.__async_client.agents.list())

    def chat(
        self, agent_id: str, messages: Message | Sequence[Message], cursor: str | None = None
    ) -> AgentChatResponse:
        """
        ...
        Examples:
            ...
            Send multiple messages at once:
                ...
                ... )
        """
        return self._run_sync(self.__async_client.agents.chat(agent_id=agent_id, messages=messages, cursor=cursor))
