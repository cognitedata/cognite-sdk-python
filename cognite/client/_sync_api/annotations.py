...
class SyncAnnotationsAPI:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.annotations.create(annotations=annotations))
    ...
    def suggest(
        ...
        """
        return self._run_sync(self.__async_client.annotations.suggest(annotations=annotations))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.annotations.update(item=item, mode=mode))
    ...
    def delete(self, id: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.annotations.delete(id=id))
    ...
    def retrieve_multiple(self, ids: Sequence[int]) -> AnnotationList:
        ...
        """
        return self._run_sync(self.__async_client.annotations.retrieve_multiple(ids=ids))
    ...
    def retrieve(self, id: int) -> Annotation | None:
        ...
        """
        return self._run_sync(self.__async_client.annotations.retrieve(id=id))
    ...
    def reverse_lookup(self, filter: AnnotationReverseLookupFilter, limit: int | None = None) -> ResourceReferenceList:
        ...
        """
        return self._run_sync(self.__async_client.annotations.reverse_lookup(filter=filter, limit=limit))
    ...
    def list(self, filter: AnnotationFilter | dict, limit: int | None = DEFAULT_LIMIT_READ) -> AnnotationList:
        ...
        """
        return self._run_sync(self.__async_client.annotations.list(filter=filter, limit=limit))
