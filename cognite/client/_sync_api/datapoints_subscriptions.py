"""
===============================================================================
9e5445ccb86ac81fb1ef07b36f3d52f5
...
class SyncDatapointsSubscriptionAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[DatapointSubscription | DatapointSubscriptionList]: No description.
        Yields:
        ...
        """
        return SyncIterator(self.__async_client.time_series.subscriptions(chunk_size=chunk_size, limit=limit))
    ...
    def create(self, subscription: DataPointSubscriptionWrite) -> DatapointSubscription:
        ...
        Examples:
            ...
            Create a filter defined subscription for all numeric time series that are stepwise:
                ...
                >>> created = client.time_series.subscriptions.create(sub)
        """
        return self._run_sync(self.__async_client.time_series.subscriptions.create(subscription=subscription))
    ...
    def retrieve(self, external_id: str) -> DatapointSubscription | None:
        ...
        """
        return self._run_sync(self.__async_client.time_series.subscriptions.retrieve(external_id=external_id))
    ...
    def update(
        ...
        Examples:
            ...
            Add a time series to a preexisting subscription:
                ...
                >>> updated = client.time_series.subscriptions.update(update)
        """
        return self._run_sync(self.__async_client.time_series.subscriptions.update(update=update, mode=mode))
    ...
    def iterate_data(
        ...
        Returns:
            Iterator[DatapointSubscriptionBatch]: No description.
        Yields:
        ...
        """
        return SyncIterator(
            self.__async_client.time_series.subscriptions(
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> DatapointSubscriptionList:
        ...
        """
        return self._run_sync(self.__async_client.time_series.subscriptions.list(limit=limit))
