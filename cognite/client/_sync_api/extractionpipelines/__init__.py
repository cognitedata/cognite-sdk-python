"""
===============================================================================
a28a7faabefe870f4f7312c56fc796f9
...
class SyncExtractionPipelinesAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[ExtractionPipeline | ExtractionPipelineList]: No description.
        Yields:
            ExtractionPipeline | ExtractionPipelineList: Yields extraction pipelines one by one or in chunks up to the chunk size.
        """
        return SyncIterator(self.__async_client.extraction_pipelines(chunk_size=chunk_size, limit=limit))
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> ExtractionPipeline | None:
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.retrieve(id=id, external_id=external_id))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> ExtractionPipelineList:
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.list(limit=limit))
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.create(extraction_pipeline=extraction_pipeline))
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.delete(id=id, external_id=external_id))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.update(item=item, mode=mode))
