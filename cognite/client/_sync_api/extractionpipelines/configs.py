...
class SyncExtractionPipelineConfigsAPI:
    ...
    def list(self, external_id: str) -> ExtractionPipelineConfigRevisionList:
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.config.list(external_id=external_id))
    ...
    def create(self, config: ExtractionPipelineConfig | ExtractionPipelineConfigWrite) -> ExtractionPipelineConfig:
        ...
        """
        return self._run_sync(self.__async_client.extraction_pipelines.config.create(config=config))
