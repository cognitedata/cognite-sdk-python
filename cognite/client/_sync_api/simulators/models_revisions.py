"""
===============================================================================
5d222b8c107a870ee8a8ea44e8d595f5
...
class SyncSimulatorModelRevisionsAPI:
    ...
    def retrieve(
        ...
        """
        return self._run_sync(
            self.__async_client.simulators.models.revisions.retrieve(ids=ids, external_ids=external_ids)
        )
    ...
    def __call__(
        ...
        last_updated_time: TimestampRange | None = None,
        limit: int | None = None,
    ) -> Iterator[SimulatorModelRevision | SimulatorModelRevisionList]:
        """
        ...
        Returns:
            Iterator[SimulatorModelRevision | SimulatorModelRevisionList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.simulators.models.revisions.create(items=items))
