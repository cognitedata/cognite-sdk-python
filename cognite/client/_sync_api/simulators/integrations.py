"""
===============================================================================
e56b11d2625b03ca032dd1491f5b320a
...
class SyncSimulatorIntegrationsAPI:
    ...
    def __call__(
        ...
        limit: int | None = None,
    ) -> AsyncIterator[SimulatorIntegrationList]: ...
    ...
    def __call__(
        ...
        active: bool | None = None,
        limit: int | None = None,
    ) -> AsyncIterator[SimulatorIntegration]: ...
    ...
    def __call__(
        ...
        Returns:
            Iterator[SimulatorIntegration | SimulatorIntegrationList]: No description.
        Yields:
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.simulators.integrations.delete(ids=ids, external_ids=external_ids))
