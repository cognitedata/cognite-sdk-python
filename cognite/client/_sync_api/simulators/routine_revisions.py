"""
===============================================================================
cae7a655a45bc12e3bc00991365524f3
...
class SyncSimulatorRoutineRevisionsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[SimulatorRoutineRevision | SimulatorRoutineRevisionList]: No description.
        Yields:
    ...
    def retrieve(
        ...
        return self._run_sync(
            self.__async_client.simulators.routines.revisions.retrieve(ids=ids, external_ids=external_ids)
        )
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.simulators.routines.revisions.create(items=items))
