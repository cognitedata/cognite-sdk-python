"""
===============================================================================
825f7d1e0c938083fc51abe2c265a6eb
...
class SyncSimulatorModelsAPI:
    ...
    def retrieve(
        ...
        Examples:
            ...
            Get multiple simulator models by external ids:
                ...
                ... )
        """
        return self._run_sync(self.__async_client.simulators.models.retrieve(ids=ids, external_ids=external_ids))
    ...
    def __call__(
        ...
        Returns:
            Iterator[SimulatorModel | SimulatorModelList]: No description.
        Yields:
    ...
    def create(self, items: SimulatorModelWrite | Sequence[SimulatorModelWrite]) -> SimulatorModel | SimulatorModelList:
        ...
        """
        return self._run_sync(self.__async_client.simulators.models.create(items=items))
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.simulators.models.delete(ids=ids, external_ids=external_ids))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.simulators.models.update(items=items))
