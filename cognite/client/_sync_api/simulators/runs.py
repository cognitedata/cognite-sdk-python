"""
===============================================================================
70a3ac6840ed0a4f0a10935b4f163ef7
...
class SyncSimulatorRunsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[SimulationRun | SimulationRunList]: No description.
        Yields:
    ...
    def retrieve(self, ids: int | Sequence[int]) -> SimulationRun | SimulationRunList | None:
        ...
        """
        return self._run_sync(self.__async_client.simulators.runs.retrieve(ids=ids))
    ...
    def create(self, items: SimulationRunWrite | Sequence[SimulationRunWrite]) -> SimulationRun | SimulationRunList:
        ...
        """
        return self._run_sync(self.__async_client.simulators.runs.create(items=items))
    ...
    def list_run_data(self, run_id: int) -> SimulationRunDataList:
        ...
        Examples:
            ...
            Get simulation run data directly on a simulation run object:
                ...
                >>> res = run.get_data()
        """
        return self._run_sync(self.__async_client.simulators.runs.list_run_data(run_id=run_id))
