"""
===============================================================================
53f216044b1a15c898402420ff2b8c43
...
class SyncSimulatorsAPI:
    ...
    def __call__(self, chunk_size: int | None = None, limit: int | None = None) -> Iterator[Simulator | SimulatorList]:
        ...
        Returns:
            Iterator[Simulator | SimulatorList]: No description.
        Yields:
            Simulator | SimulatorList: yields Simulator one by one if chunk is not specified, else SimulatorList objects.
        """
        return SyncIterator(self.__async_client.simulators(chunk_size=chunk_size, limit=limit))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> SimulatorList:
        ...
        """
        return self._run_sync(self.__async_client.simulators.list(limit=limit))
