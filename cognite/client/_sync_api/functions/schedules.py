"""
===============================================================================
b520c115b3bf6e2aabf70088c8e15ac2
...
class SyncFunctionSchedulesAPI:
    ...
    def retrieve(
        ...
        return self._run_sync(
            self.__async_client.functions.schedules.retrieve(id=id, ignore_unknown_ids=ignore_unknown_ids)
        )
    ...
    def delete(self, id: int) -> None:
        ...
        """
        return self._run_sync(self.__async_client.functions.schedules.delete(id=id))
    ...
    def get_input_data(self, id: int) -> dict[str, object] | None:
        ...
        """
        return self._run_sync(self.__async_client.functions.schedules.get_input_data(id=id))
