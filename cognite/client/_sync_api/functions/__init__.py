"""
===============================================================================
31e0ee3e4eac834c372cc7b9b3d44506
...
class SyncFunctionsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Function | FunctionList]: No description.
        Yields:
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.functions.delete(id=id, external_id=external_id))
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> Function | None:
        ...
        """
        return self._run_sync(self.__async_client.functions.retrieve(id=id, external_id=external_id))
    ...
    def limits(self) -> FunctionsLimits:
        ...
        """
        return self._run_sync(self.__async_client.functions.limits())
    ...
    def activate(self) -> FunctionsStatus:
        ...
        """
        return self._run_sync(self.__async_client.functions.activate())
    ...
    def status(self) -> FunctionsStatus:
        ...
        """
        return self._run_sync(self.__async_client.functions.status())
