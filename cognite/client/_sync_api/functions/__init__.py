"""
===============================================================================
30dd56993fb13a086f4c4cf54d71d50c
...
class SyncFunctionsAPI(SyncAPIClient):
    ...
    def create(
        ...
        Args:
            ...
            runtime (RunTime | None): The function runtime. Valid values are ["py310", "py311", "py312", "py313", "py314", `None`], and `None` translates to the API default which will change over time. The runtime "py313" resolves to the latest version of the Python 3.13 series.
