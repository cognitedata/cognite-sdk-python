"""
===============================================================================
46b48615281f45178347bb8ad56f1289
...
class SyncSequencesDataAPI:
    ...
    def insert(
        ...
        **kwargs: Any,
        ...
        return self._run_sync(
            self.__async_client.sequences.data.insert(
                rows=rows, columns=columns, id=id, external_id=external_id, **kwargs
            )
        )
    ...
    def delete(self, rows: typing.Sequence[int], id: int | None = None, external_id: str | None = None) -> None:
        ...
        """
        return self._run_sync(self.__async_client.sequences.data.delete(rows=rows, id=id, external_id=external_id))
        ...
        **kwargs: Any,
        ...
        return self._run_sync(
            self.__async_client.sequences.data.retrieve(
                external_id=external_id, id=id, start=start, end=end, columns=columns, limit=limit, **kwargs
            )
        )
        ...
        **kwargs: Any,
        ...
        return self._run_sync(
            self.__async_client.sequences.data.retrieve_last_row(
                id=id, external_id=external_id, columns=columns, before=before, **kwargs
            )
        )
