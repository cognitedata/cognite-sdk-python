"""
===============================================================================
55e12b683bdd5552c182102f5f32ed42
...
class SyncThreeDRevisionsAPI:
    ...
    def __call__(
    ...
    ) -> Iterator[ThreeDModelRevision | ThreeDModelRevisionList]:
        """
        ...
        Returns:
            Iterator[ThreeDModelRevision | ThreeDModelRevisionList]: No description.
        Yields:
    ...
    def retrieve(self, model_id: int, id: int) -> ThreeDModelRevision | None:
        ...
        """
        return self._run_sync(self.__async_client.three_d.revisions.retrieve(model_id=model_id, id=id))
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.three_d.revisions.create(model_id=model_id, revision=revision))
    ...
    def list(
        ...
        return self._run_sync(
            self.__async_client.three_d.revisions.list(model_id=model_id, published=published, limit=limit)
        )
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.three_d.revisions.update(model_id=model_id, item=item, mode=mode))
    ...
    def delete(self, model_id: int, id: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.three_d.revisions.delete(model_id=model_id, id=id))
