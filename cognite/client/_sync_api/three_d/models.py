"""
===============================================================================
48a2b24014de8e3cfec0c65f0badf7a8
...
class SyncThreeDModelsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[ThreeDModel | ThreeDModelList]: No description.
        Yields:
            ThreeDModel | ThreeDModelList: yields ThreeDModel one by one if chunk is not specified, else ThreeDModelList objects.
        """
        return SyncIterator(self.__async_client.three_d.models(chunk_size=chunk_size, published=published, limit=limit))
    ...
    def retrieve(self, id: int) -> ThreeDModel | None:
        ...
        """
        return self._run_sync(self.__async_client.three_d.models.retrieve(id=id))
    ...
    def list(self, published: bool | None = None, limit: int | None = DEFAULT_LIMIT_READ) -> ThreeDModelList:
        ...
        Examples:
            ...
            Iterate over chunks of 3d models to reduce memory load:
                ...
                ...     model # do something with the 3d model
        """
        return self._run_sync(self.__async_client.three_d.models.list(published=published, limit=limit))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.three_d.models.update(item=item, mode=mode))
    ...
    def delete(self, id: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.three_d.models.delete(id=id))
