...
class SyncDocumentPreviewAPI:
    ...
    def download_document_as_pdf_bytes(self, id: int) -> bytes:
        ...
        """
        return self._run_sync(self.__async_client.documents.previews.download_document_as_pdf_bytes(id=id))
    ...
    def retrieve_pdf_link(self, id: int) -> TemporaryLink:
        ...
        """
        return self._run_sync(self.__async_client.documents.previews.retrieve_pdf_link(id=id))
