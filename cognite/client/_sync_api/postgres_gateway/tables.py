"""
===============================================================================
63dd1fa43d871064390ca626265db8a4
...
class SyncTablesAPI:
    ...
    def __call__(self, chunk_size: int | None = None, limit: int | None = None) -> Iterator[pg.Table | pg.TableList]:
        ...
        Yields:
            pg.Table | pg.TableList: No description.
        Returns:
            Iterator[pg.Table | pg.TableList]: yields Table one by one if chunk_size is not specified, else TableList objects.
        """
        return SyncIterator(self.__async_client.postgres_gateway.tables(chunk_size=chunk_size, limit=limit))
    ...
    def create(self, username: str, items: pg.TableWrite | Sequence[pg.TableWrite]) -> pg.Table | pg.TableList:
        ...
        """
        return self._run_sync(self.__async_client.postgres_gateway.tables.create(username=username, items=items))
