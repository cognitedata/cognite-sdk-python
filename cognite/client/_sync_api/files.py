"""
===============================================================================
7ec1ad19a9523ad855db045e4e9ccd37
...
class SyncFilesAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[FileMetadata | FileMetadataList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.files.create(file_metadata=file_metadata, overwrite=overwrite))
    ...
    def retrieve(
        ...
        return self._run_sync(
            self.__async_client.files.retrieve(id=id, external_id=external_id, instance_id=instance_id)
        )
    ...
    def aggregate(self, filter: FileMetadataFilter | dict[str, Any] | None = None) -> list[CountAggregate]:
        ...
        """
        return self._run_sync(self.__async_client.files.aggregate(filter=filter))
    ...
    def update(
        ...
        Examples:
            ...
            Detach a single label from a file:
                ...
                >>> res = client.files.update(my_update)
        """
        return self._run_sync(self.__async_client.files.update(item=item, mode=mode))
    ...
    def search(
        ...
        """
        return self._run_sync(self.__async_client.files.search(name=name, filter=filter, limit=limit))

    def upload_content(
        self, path: str, external_id: str | None = None, instance_id: NodeId | None = None
    ) -> FileMetadata:
        """
