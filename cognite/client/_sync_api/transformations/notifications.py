"""
===============================================================================
28b5925c447f0ed9da53270f969b0d1a
...
class SyncTransformationNotificationsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[TransformationNotification | TransformationNotificationList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.transformations.notifications.create(notification=notification))
    ...
    def delete(self, id: int | Sequence[int] | None = None) -> None:
        ...
        """
        return self._run_sync(self.__async_client.transformations.notifications.delete(id=id))
