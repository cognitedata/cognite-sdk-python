"""
===============================================================================
def9cacad60c6fd847a0329819841cb2
...
class SyncTransformationsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Transformation | TransformationList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.transformations.create(transformation=transformation))
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> Transformation | None:
        ...
        """
        return self._run_sync(self.__async_client.transformations.retrieve(id=id, external_id=external_id))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.transformations.update(item=item, mode=mode))
