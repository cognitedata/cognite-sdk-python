...
class SyncTransformationJobsAPI:
    ...
    def retrieve(self, id: int) -> TransformationJob | None:
        ...
        """
        return self._run_sync(self.__async_client.transformations.jobs.retrieve(id=id))
    ...
    def list_metrics(self, id: int) -> TransformationJobMetricList:
        ...
        """
        return self._run_sync(self.__async_client.transformations.jobs.list_metrics(id=id))
