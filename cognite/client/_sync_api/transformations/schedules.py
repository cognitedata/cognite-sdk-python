"""
===============================================================================
39ca9c67782b17f91611f152dd316790
...
class SyncTransformationSchedulesAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[TransformationSchedule | TransformationScheduleList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.transformations.schedules.create(schedule=schedule))
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> TransformationSchedule | None:
        ...
        """
        return self._run_sync(self.__async_client.transformations.schedules.retrieve(id=id, external_id=external_id))
    ...
    def list(self, include_public: bool = True, limit: int | None = DEFAULT_LIMIT_READ) -> TransformationScheduleList:
        ...
        """
        return self._run_sync(
            self.__async_client.transformations.schedules.list(include_public=include_public, limit=limit)
        )
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.transformations.schedules.update(item=item, mode=mode))
