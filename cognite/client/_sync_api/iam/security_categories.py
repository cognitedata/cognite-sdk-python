...
class SyncSecurityCategoriesAPI:
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> SecurityCategoryList:
        ...
        """
        return self._run_sync(self.__async_client.iam.security_categories.list(limit=limit))
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.iam.security_categories.create(security_category=security_category))
    ...
    def delete(self, id: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.iam.security_categories.delete(id=id))
