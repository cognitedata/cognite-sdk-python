...
class SyncSessionsAPI:
    ...
    def revoke(self, id: int | Sequence[int]) -> Session | SessionList:
        ...
        """
        return self._run_sync(self.__async_client.iam.sessions.revoke(id=id))
    ...
    def retrieve(self, id: int | Sequence[int]) -> Session | SessionList:
        ...
        """
        return self._run_sync(self.__async_client.iam.sessions.retrieve(id=id))
    ...
    def list(self, status: SessionStatus | None = None, limit: int = DEFAULT_LIMIT_READ) -> SessionList:
        ...
        """
        return self._run_sync(self.__async_client.iam.sessions.list(status=status, limit=limit))
