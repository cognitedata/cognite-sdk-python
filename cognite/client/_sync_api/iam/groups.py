...
class SyncGroupsAPI:
    ...
    def list(self, all: bool = False) -> GroupList:
        ...
        """
        return self._run_sync(self.__async_client.iam.groups.list(all=all))
    ...
    def create(self, group: Group | GroupWrite | Sequence[Group] | Sequence[GroupWrite]) -> Group | GroupList:
        ...
        """
        return self._run_sync(self.__async_client.iam.groups.create(group=group))
    ...
    def delete(self, id: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.iam.groups.delete(id=id))
