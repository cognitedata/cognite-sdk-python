"""
===============================================================================
95feaf9c73e512e011f7a63fe17ae476
...
class SyncGeospatialAPI:
    ...
    def create_feature_types(
        ...
        """
        return self._run_sync(self.__async_client.geospatial.create_feature_types(feature_type=feature_type))
    ...
    def list_feature_types(self) -> FeatureTypeList:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.list_feature_types())
    ...
    def retrieve_feature_types(self, external_id: str | list[str]) -> FeatureType | FeatureTypeList:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.retrieve_feature_types(external_id=external_id))
    ...
    def patch_feature_types(self, patch: FeatureTypePatch | Sequence[FeatureTypePatch]) -> FeatureTypeList:
        ...
        Examples:
            ...
            Add an additional index to an existing property
                ...
                ... ))
        """
        return self._run_sync(self.__async_client.geospatial.patch_feature_types(patch=patch))
    ...
    def stream_features(
        ...
        Returns:
            Iterator[Feature]: No description.
        Yields:
    ...
    def get_coordinate_reference_systems(self, srids: int | Sequence[int]) -> CoordinateReferenceSystemList:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.get_coordinate_reference_systems(srids=srids))
    ...
    def list_coordinate_reference_systems(self, only_custom: bool = False) -> CoordinateReferenceSystemList:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.list_coordinate_reference_systems(only_custom=only_custom))
    ...
    def create_coordinate_reference_systems(
        ...
        """
        return self._run_sync(self.__async_client.geospatial.create_coordinate_reference_systems(crs=crs))
    ...
    def delete_coordinate_reference_systems(self, srids: int | Sequence[int]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.delete_coordinate_reference_systems(srids=srids))
    ...
    def compute(self, output: dict[str, GeospatialComputeFunction]) -> GeospatialComputedResponse:
        ...
        """
        return self._run_sync(self.__async_client.geospatial.compute(output=output))
