"""
===============================================================================
04e3fc3af618a57c3518e1142058984d
...
class SyncSequencesAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Sequence | SequenceList]: No description.
        Yields:
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> Sequence | None:
        ...
        """
        return self._run_sync(self.__async_client.sequences.retrieve(id=id, external_id=external_id))
    ...
    def aggregate(self, filter: SequenceFilter | dict[str, Any] | None = None) -> list[CountAggregate]:
        ...
        """
        return self._run_sync(self.__async_client.sequences.aggregate(filter=filter))
    ...
    def aggregate_count(
        ...
        """
        return self._run_sync(
            self.__async_client.sequences.aggregate_count(advanced_filter=advanced_filter, filter=filter)
        )
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.sequences.create(sequence=sequence))
        ...
        Examples:
            ...
            **Updating column definitions**
            ...
            Update existing columns:
                ...
                >>> res = client.sequences.update(my_update)
        """
        return self._run_sync(self.__async_client.sequences.update(item=item, mode=mode))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.sequences.upsert(item=item, mode=mode))
    ...
    def filter(
        ...
        """
        return self._run_sync(self.__async_client.sequences.filter(filter=filter, sort=sort, limit=limit))
