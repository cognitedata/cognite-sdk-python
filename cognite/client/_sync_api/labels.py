"""
===============================================================================
136550fcd0d99fb992b50afbaa1af010
...
class SyncLabelsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[LabelDefinition | LabelDefinitionList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.labels.create(label=label))
    ...
    def delete(self, external_id: str | SequenceNotStr[str] | None = None) -> None:
        ...
        """
        return self._run_sync(self.__async_client.labels.delete(external_id=external_id))
