"""
===============================================================================
1cb92a14ed0f9e4ba3e396da84ed8533
...
class SyncInstancesAPI:
    ...
    def __call__(
        ...
        return self._run_sync(
            self.__async_client.data_modeling.instances.__call__(
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.instances.delete(nodes=nodes, edges=edges))
    ...
    def query(self, query: Query, include_typing: bool = False) -> QueryResult:
        ...
        """
        return self._run_sync(
            self.__async_client.data_modeling.instances.query(query=query, include_typing=include_typing)
        )
    ...
    def sync(self, query: Query, include_typing: bool = False) -> QueryResult:
        ...
        """
        return self._run_sync(
            self.__async_client.data_modeling.instances.sync(query=query, include_typing=include_typing)
        )
