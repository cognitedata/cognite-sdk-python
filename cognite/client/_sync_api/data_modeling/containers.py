"""
===============================================================================
5949d74b3ee29fbd664a1699bdab4b27
...
class SyncContainersAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Container | ContainerList]: No description.
        Yields:
    ...
    def retrieve(self, ids: ContainerIdentifier | Sequence[ContainerIdentifier]) -> Container | ContainerList | None:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.containers.retrieve(ids=ids))
    ...
    def delete(self, ids: ContainerIdentifier | Sequence[ContainerIdentifier]) -> list[ContainerId]:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.containers.delete(ids=ids))
    ...
    def delete_constraints(self, ids: Sequence[ConstraintIdentifier]) -> list[ConstraintIdentifier]:
        ...
        Examples:
            ...
            Delete constraints by id:
                ...
                ... )
        """
        return self._run_sync(self.__async_client.data_modeling.containers.delete_constraints(ids=ids))
    ...
    def delete_indexes(self, ids: Sequence[IndexIdentifier]) -> list[IndexIdentifier]:
        ...
        Examples:
            ...
            Delete indexes by id:
                ...
                ... )
        """
        return self._run_sync(self.__async_client.data_modeling.containers.delete_indexes(ids=ids))
    ...
    def apply(self, container: ContainerApply | Sequence[ContainerApply]) -> Container | ContainerList:
        ...
        Examples:
            ...
            depending on the choice of property type (e.g. ``auto_increment`` only works with integer types).
                ...
                ... )
        """
        return self._run_sync(self.__async_client.data_modeling.containers.apply(container=container))
