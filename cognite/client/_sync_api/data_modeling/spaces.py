"""
===============================================================================
9b249a7849d81fa15886f624b149fac7
...
class SyncSpacesAPI:
    ...
    def __call__(self, chunk_size: int | None = None, limit: int | None = None) -> Iterator[Space | SpaceList]:
        ...
        Returns:
            Iterator[Space | SpaceList]: No description.
        Yields:
            Space | SpaceList: yields Space one by one if chunk_size is not specified, else SpaceList objects.
        """
        return SyncIterator(self.__async_client.data_modeling.spaces(chunk_size=chunk_size, limit=limit))
    ...
    def retrieve(self, spaces: str | SequenceNotStr[str]) -> Space | SpaceList | None:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.spaces.retrieve(spaces=spaces))
    ...
    def delete(self, spaces: str | SequenceNotStr[str]) -> list[str]:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.spaces.delete(spaces=spaces))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ, include_global: bool = False) -> SpaceList:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.spaces.list(limit=limit, include_global=include_global))
    ...
    def apply(self, spaces: SpaceApply | Sequence[SpaceApply]) -> Space | SpaceList:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.spaces.apply(spaces=spaces))
