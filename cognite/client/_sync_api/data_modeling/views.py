"""
===============================================================================
2df9dcfce887d40553c0fc407b0b4439
...
class SyncViewsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[View | ViewList]: No description.
        Yields:
    ...
    def delete(self, ids: ViewIdentifier | Sequence[ViewIdentifier]) -> list[ViewId]:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.views.delete(ids=ids))
    ...
    def apply(self, view: ViewApply | Sequence[ViewApply]) -> View | ViewList:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.views.apply(view=view))
