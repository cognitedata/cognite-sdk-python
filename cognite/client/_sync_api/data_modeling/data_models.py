"""
===============================================================================
735819853fb32ee20506c373cca90430
...
class SyncDataModelsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[DataModel | DataModelList]: No description.
        Yields:
    ...
    def retrieve(
        ...
        return self._run_sync(
            self.__async_client.data_modeling.data_models.retrieve(ids=ids, inline_views=inline_views)
        )
    ...
    def delete(self, ids: DataModelIdentifier | Sequence[DataModelIdentifier]) -> list[DataModelId]:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.data_models.delete(ids=ids))
    ...
    def apply(self, data_model: DataModelApply | Sequence[DataModelApply]) -> DataModel | DataModelList:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.data_models.apply(data_model=data_model))
