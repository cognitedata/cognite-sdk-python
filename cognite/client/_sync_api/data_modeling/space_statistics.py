"""
===============================================================================
a3ee84e453c9daca8f9575b05956c856
...
class SyncSpaceStatisticsAPI:
    ...
    def retrieve(self, space: str | SequenceNotStr[str]) -> SpaceStatistics | SpaceStatisticsList | None:
        ...
        Examples:
            ...
            Fetch statistics for multiple spaces:
                ...
                ... )
        """
        return self._run_sync(self.__async_client.data_modeling.statistics.spaces.retrieve(space=space))
    ...
    def list(self) -> SpaceStatisticsList:
        ...
        """
        return self._run_sync(self.__async_client.data_modeling.statistics.spaces.list())
