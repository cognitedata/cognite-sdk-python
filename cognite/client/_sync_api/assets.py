"""
===============================================================================
95d9012f22d32c8ca879ba71d1eb886c
...
class SyncAssetsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Asset | AssetList]: No description.
        Yields:
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> Asset | None:
        ...
        """
        return self._run_sync(self.__async_client.assets.retrieve(id=id, external_id=external_id))
    ...
    def aggregate(self, filter: AssetFilter | dict[str, Any] | None = None) -> list[CountAggregate]:
        ...
        """
        return self._run_sync(self.__async_client.assets.aggregate(filter=filter))
    ...
    def create(self, asset: Asset | AssetWrite | Sequence[Asset] | Sequence[AssetWrite]) -> Asset | AssetList:
        ...
        """
        return self._run_sync(self.__async_client.assets.create(asset=asset))
    ...
    def update(
        ...
        Examples:
            ...
            Replace all labels for an asset:
                ...
                >>> res = client.assets.update(my_update)
        """
        return self._run_sync(self.__async_client.assets.update(item=item, mode=mode))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.assets.upsert(item=item, mode=mode))
    ...
    def filter(
        ...
        """
        return self._run_sync(
            self.__async_client.assets.filter(
                filter=filter, sort=sort, aggregated_properties=aggregated_properties, limit=limit
            )
        )
    ...
    def retrieve_subtree(
        ...
        """
        return self._run_sync(self.__async_client.assets.retrieve_subtree(id=id, external_id=external_id, depth=depth))
