"""
===============================================================================
74f96bba5f75c9caff67e8e9a697690d
...
class SyncWorkflowAPI:
    ...
    def __call__(self, chunk_size: int | None = None, limit: int | None = None) -> Iterator[Workflow | WorkflowList]:
        ...
        Returns:
            Iterator[Workflow | WorkflowList]: No description.
        Yields:
            Workflow | WorkflowList: Yields Workflow one by one if chunk_size is None, otherwise yields WorkflowList objects.
        """
        return SyncIterator(self.__async_client.workflows(chunk_size=chunk_size, limit=limit))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.workflows.upsert(workflow=workflow, mode=mode))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> WorkflowList:
        ...
        """
        return self._run_sync(self.__async_client.workflows.list(limit=limit))
