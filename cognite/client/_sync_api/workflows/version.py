"""
===============================================================================
aa7782cf185a4e77f4af807ff18e97c2
...
from collections.abc import AsyncIterator, Coroutine, Iterator, MutableSequence, Sequence
...
class SyncWorkflowVersionAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[WorkflowVersion | WorkflowVersionList]: No description.
        Yields:
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.workflows.versions.upsert(version=version, mode=mode))
        ...
        *,
        ...
        return self._run_sync(
            self.__async_client.workflows.versions.retrieve(
                workflow_external_id=workflow_external_id, version=version, ignore_unknown_ids=ignore_unknown_ids
            )
        )
