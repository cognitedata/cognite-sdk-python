"""
===============================================================================
472acea7f4dd290e9e179e037810a4ea
...
class SyncWorkflowExecutionAPI:
    ...
    def retrieve_detailed(self, id: str) -> WorkflowExecutionDetailed | None:
        ...
        """
        return self._run_sync(self.__async_client.workflows.executions.retrieve_detailed(id=id))
    ...
    def trigger(
        ...
        return self._run_sync(
            self.__async_client.workflows.executions.trigger(
    ...
    def cancel(self, id: str, reason: str | None) -> WorkflowExecution:
        ...
        """
        return self._run_sync(self.__async_client.workflows.executions.cancel(id=id, reason=reason))
    ...
    def retry(self, id: str, client_credentials: ClientCredentials | None = None) -> WorkflowExecution:
        ...
        """
        return self._run_sync(
            self.__async_client.workflows.executions.retry(id=id, client_credentials=client_credentials)
        )
