"""
===============================================================================
2077f26578508212426be5d06ba9fe1f
...
class SyncWorkflowTaskAPI:
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.workflows.tasks.update(task_id=task_id, status=status, output=output))
