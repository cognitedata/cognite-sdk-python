"""
===============================================================================
5c43e7540fde166f93e8444a861270ae
...
class SyncUserProfilesAPI:
    ...
    def enable(self) -> UserProfilesConfiguration:
        ...
        """
        return self._run_sync(self.__async_client.iam.user_profiles.enable())

    def disable(self) -> UserProfilesConfiguration:
        """
        Disable user profiles for the project
        """
        return self._run_sync(self.__async_client.iam.user_profiles.disable())
    ...
    def me(self) -> UserProfile:
        ...
        """
        return self._run_sync(self.__async_client.iam.user_profiles.me())
    ...
    def retrieve(self, user_identifier: str | SequenceNotStr[str]) -> UserProfile | UserProfileList | None:
        ...
        """
        return self._run_sync(self.__async_client.iam.user_profiles.retrieve(user_identifier=user_identifier))
    ...
    def search(self, name: str, limit: int = DEFAULT_LIMIT_READ) -> UserProfileList:
        ...
        """
        return self._run_sync(self.__async_client.iam.user_profiles.search(name=name, limit=limit))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> UserProfileList:
        ...
        """
        return self._run_sync(self.__async_client.iam.user_profiles.list(limit=limit))
