...
class SyncDiagramsAPI:
    ...
    def get_detect_jobs(self, job_ids: list[int]) -> list[DiagramDetectResults]:
        return self._run_sync(self.__async_client.diagrams.get_detect_jobs(job_ids=job_ids))
    ...
    def convert(self, detect_job: DiagramDetectResults) -> DiagramConvertResults:
        ...
        """
        return self._run_sync(self.__async_client.diagrams.convert(detect_job=detect_job))
