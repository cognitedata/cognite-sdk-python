"""
===============================================================================
3a9db9695207f1ee47454489c07d052f
...
class SyncRawRowsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Row | RowList]: No description.
        Yields:
    ...
    def delete(self, db_name: str, table_name: str, key: str | SequenceNotStr[str]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.raw.rows.delete(db_name=db_name, table_name=table_name, key=key))
    ...
    def retrieve(self, db_name: str, table_name: str, key: str) -> Row | None:
        ...
        Examples:
            ...
            You may access the data directly on the row (like a dict), or use '.get' when keys can be missing:
                ...
                >>> val2 = row.get("col2")
        """
        return self._run_sync(self.__async_client.raw.rows.retrieve(db_name=db_name, table_name=table_name, key=key))
