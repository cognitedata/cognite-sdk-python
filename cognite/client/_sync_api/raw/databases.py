"""
===============================================================================
28bd7a4902429331b17c71f5eb707159
...
class SyncRawDatabasesAPI:
    ...
    def __call__(self, chunk_size: int | None = None, limit: int | None = None) -> Iterator[Database | DatabaseList]:
        ...
        Returns:
            Iterator[Database | DatabaseList]: No description.
        Yields:
            Database | DatabaseList: No description.
        """
        return SyncIterator(self.__async_client.raw.databases(chunk_size=chunk_size, limit=limit))
    ...
    def create(self, name: str | list[str]) -> Database | DatabaseList:
        ...
        """
        return self._run_sync(self.__async_client.raw.databases.create(name=name))
    ...
    def delete(self, name: str | SequenceNotStr[str], recursive: bool = False) -> None:
        ...
        """
        return self._run_sync(self.__async_client.raw.databases.delete(name=name, recursive=recursive))
    ...
    def list(self, limit: int | None = DEFAULT_LIMIT_READ) -> DatabaseList:
        ...
        """
        return self._run_sync(self.__async_client.raw.databases.list(limit=limit))
