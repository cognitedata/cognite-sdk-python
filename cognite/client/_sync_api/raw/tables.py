"""
===============================================================================
5eb7a87861b27461daae17159ede4091
...
class SyncRawTablesAPI:
    ...
    @overload
    def __call__(self, db_name: str, chunk_size: None = None, limit: int | None = None) -> AsyncIterator[raw.Table]: ...

    @overload
    def __call__(self, db_name: str, chunk_size: int, limit: int | None = None) -> AsyncIterator[raw.TableList]: ...
    ...
    def __call__(
        ...
        Returns:
            Iterator[raw.Table | raw.TableList]: No description.
        """
        return SyncIterator(self.__async_client.raw.tables(db_name=db_name, chunk_size=chunk_size, limit=limit))
    ...
    def create(self, db_name: str, name: str | list[str]) -> raw.Table | raw.TableList:
        ...
        """
        return self._run_sync(self.__async_client.raw.tables.create(db_name=db_name, name=name))
    ...
    def delete(self, db_name: str, name: str | SequenceNotStr[str]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.raw.tables.delete(db_name=db_name, name=name))
    ...
    def list(self, db_name: str, limit: int | None = DEFAULT_LIMIT_READ) -> raw.TableList:
        ...
        """
        return self._run_sync(self.__async_client.raw.tables.list(db_name=db_name, limit=limit))
