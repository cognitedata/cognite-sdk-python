"""
===============================================================================
9bd92bfdfb7a46cecd482d595496273a
...
class SyncDatapointsAPI:
    ...
    def __call__(
        ...
        *,
        ...
        Returns:
            Iterator[DatapointsArray | DatapointsArrayList | Datapoints | DatapointsList]: No description.
        Yields:
    ...
    def insert_multiple(
        ...
        """
        return self._run_sync(self.__async_client.time_series.data.insert_multiple(datapoints=datapoints))
    ...
    def delete_ranges(self, ranges: list[dict[str, Any]]) -> None:
        ...
        """
        return self._run_sync(self.__async_client.time_series.data.delete_ranges(ranges=ranges))
    ...
    def insert_dataframe(
        ...
        """
        return self._run_sync(
            self.__async_client.time_series.data.insert_dataframe(
                df=df, external_id_headers=external_id_headers, dropna=dropna, instance_id_headers=instance_id_headers
            )
        )
