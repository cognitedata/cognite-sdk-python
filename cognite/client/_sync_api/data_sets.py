"""
===============================================================================
dc985794b39c9c9c214641104fc5da77
...
class SyncDataSetsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[DataSet | DataSetList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.data_sets.create(data_set=data_set))
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> DataSet | None:
        ...
        """
        return self._run_sync(self.__async_client.data_sets.retrieve(id=id, external_id=external_id))
    ...
    def aggregate(self, filter: DataSetFilter | dict[str, Any] | None = None) -> list[CountAggregate]:
        ...
        """
        return self._run_sync(self.__async_client.data_sets.aggregate(filter=filter))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.data_sets.update(item=item, mode=mode))
