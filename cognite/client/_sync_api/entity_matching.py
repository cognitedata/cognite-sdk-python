...
class SyncEntityMatchingAPI:
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> EntityMatchingModel | None:
        ...
        """
        return self._run_sync(self.__async_client.entity_matching.retrieve(id=id, external_id=external_id))
    ...
    def retrieve_multiple(
        ...
        """
        return self._run_sync(self.__async_client.entity_matching.retrieve_multiple(ids=ids, external_ids=external_ids))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.entity_matching.update(item=item, mode=mode))
    ...
    def list_jobs(self) -> ContextualizationJobList:
        ...
        """
        return self._run_sync(self.__async_client.entity_matching.list_jobs())
    ...
    def delete(
        ...
        """
        return self._run_sync(self.__async_client.entity_matching.delete(id=id, external_id=external_id))
