"""
===============================================================================
9bf2c4e484b9526cf3704f8fc4346cd4
...
class SyncEventsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Event | EventList]: No description.
        Yields:
    ...
    def retrieve(self, id: int | None = None, external_id: str | None = None) -> Event | None:
        ...
        """
        return self._run_sync(self.__async_client.events.retrieve(id=id, external_id=external_id))
    ...
    def aggregate(self, filter: EventFilter | dict[str, Any] | None = None) -> list[AggregateResult]:
        ...
        """
        return self._run_sync(self.__async_client.events.aggregate(filter=filter))
    ...
    def create(self, event: Event | EventWrite | Sequence[Event] | Sequence[EventWrite]) -> Event | EventList:
        ...
        """
        return self._run_sync(self.__async_client.events.create(event=event))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.events.update(item=item, mode=mode))
    ...
    def search(
        ...
        """
        return self._run_sync(self.__async_client.events.search(description=description, filter=filter, limit=limit))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.events.upsert(item=item, mode=mode))
    ...
    def filter(
        ...
        """
        return self._run_sync(self.__async_client.events.filter(filter=filter, sort=sort, limit=limit))
