"""
===============================================================================
0b42b7b8b84eef9ab269b0c664d3da2b
...
class SyncTimeSeriesAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[TimeSeries | TimeSeriesList]: No description.
        Yields:
    ...
    def retrieve(
        ...
        return self._run_sync(
            self.__async_client.time_series.retrieve(id=id, external_id=external_id, instance_id=instance_id)
        )
    ...
    def retrieve_multiple(
        ...
        """
        return self._run_sync(
            self.__async_client.time_series.retrieve_multiple(
    ...
    def aggregate(self, filter: TimeSeriesFilter | dict[str, Any] | None = None) -> list[CountAggregate]:
        ...
        """
        return self._run_sync(self.__async_client.time_series.aggregate(filter=filter))
    ...
    def aggregate_count(
        ...
        """
        return self._run_sync(
            self.__async_client.time_series.aggregate_count(advanced_filter=advanced_filter, filter=filter)
        )
    ...
    def aggregate_unique_values(
        ...
        """
        return self._run_sync(
            self.__async_client.time_series.aggregate_unique_values(
                property=property, advanced_filter=advanced_filter, aggregate_filter=aggregate_filter, filter=filter
            )
        )
    ...
    def aggregate_unique_properties(
        ...
        """
        return self._run_sync(
            self.__async_client.time_series.aggregate_unique_properties(
                path=path, advanced_filter=advanced_filter, aggregate_filter=aggregate_filter, filter=filter
            )
        )
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.time_series.create(time_series=time_series))
    ...
    def update(
        ...
        """
        return self._run_sync(self.__async_client.time_series.update(item=item, mode=mode))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.time_series.upsert(item=item, mode=mode))
    ...
    def filter(
        ...
        """
        return self._run_sync(self.__async_client.time_series.filter(filter=filter, sort=sort, limit=limit))
