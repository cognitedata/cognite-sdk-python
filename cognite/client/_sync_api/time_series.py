"""
===============================================================================
c1f3075df93d8a1559cadc6708faccb3
...
class SyncTimeSeriesAPI(SyncAPIClient):
    ...
    def aggregate_count(
        ...
        """
        return run_sync(self.__async_client.time_series.aggregate_count(advanced_filter=advanced_filter, filter=filter))
    ...
    def update(
        ...
        """
        return run_sync(self.__async_client.time_series.update(item=item, mode=mode))
