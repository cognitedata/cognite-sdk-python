"""
===============================================================================
0387689c5e1b6908c51cdbfc57434c8c
...
class SyncRelationshipsAPI:
    ...
    def __call__(
        ...
        Returns:
            Iterator[Relationship | RelationshipList]: No description.
        Yields:
    ...
    def create(
        ...
        """
        return self._run_sync(self.__async_client.relationships.create(relationship=relationship))
    ...
    def update(
        ...
        Examples:
            ...
            Detach a single label from a relationship:
                ...
                >>> res = client.relationships.update(my_update)
        """
        return self._run_sync(self.__async_client.relationships.update(item=item, mode=mode))
    ...
    def upsert(
        ...
        """
        return self._run_sync(self.__async_client.relationships.upsert(item=item, mode=mode))
