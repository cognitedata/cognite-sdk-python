...
class ClientConfig():
    ...
    def __init__(self, client_name, project, credentials, api_subversion=None, base_url=None, max_workers=None, headers=None, timeout=None, file_transfer_timeout=None, debug=False):
