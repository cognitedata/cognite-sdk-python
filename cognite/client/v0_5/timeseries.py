...
class TimeSeriesClientV0_5(APIClient):
    def get_timeseries(
        ...
        Returns:
            v0_5.dto.TimeSeriesResponse: A data object containing the requested timeseries with several getter methods with different
            output formats.
        """
        url = "/timeseries"
        params = {
    ...
    def post_time_series(self, time_series: List[TimeSeries]) -> Dict:
        ...
        Args:
            time_series (list[v0_5.dto.TimeSeries]):   List of time series data transfer objects to create.
    ...
    def update_time_series(self, time_series: List[TimeSeries]) -> Dict:
        ...
        Args:
            time_series (list[v0_5.dto.TimeSeries]):   List of time series data transfer objects to update.
