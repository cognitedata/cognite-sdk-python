...
class TagMatchingClientV0_5(APIClient):
    def tag_matching(self, tag_ids, fuzzy_threshold=0, platform=None) -> TagMatchingResponse:
        ...
        Returns:
            v0_5.tagmatching.TagMatchingResponse: A data object containing the requested data with several getter methods with different
            output formats.
        """
        url = "/tagmatching"
