...
class FilesClientV0_5(APIClient):
    def upload_file(
    ...
    def list_files(self, name=None, directory=None, file_type=None, source=None, **kwargs) -> FileListResponse:
        ...
        Returns:
            v0_5.files.FileListResponse: A data object containing the requested files information.
        """
        url = "/files"
        params = {
    ...
    def get_file_info(self, id) -> FileInfoResponse:
        ...
        Returns:
            v0_5.files.FileInfoResponse: A data object containing the requested file information.
        """
        url = "/files/{}".format(id)
        res = self._get(url)
