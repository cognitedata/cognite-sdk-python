...
class RawClientV0_5(APIClient):
    def get_databases(self, limit: int = None, cursor: str = None) -> RawResponse:
        ...
        Returns:
            v0_5.raw.RawResponse: A data object containing the requested data with several getter methods with different
            output formats.
        """
        url = "/raw"
    ...
    def create_rows(
        ...
        Args:
            ...
            rows (list[v0_5.raw.RawRow]):            The rows to create.
