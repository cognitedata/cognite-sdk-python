...
class TimeseriesWithDatapoints:
    ...
    Args:
        ...
        datapoints (List[v0_5.datapoints.Datapoint]): List of datapoints in the timeseries.
    """
...
class DatapointsClientV0_5(APIClient):
    def get_datapoints(self, name, start, end=None, aggregates=None, granularity=None, **kwargs) -> DatapointsResponse:
        ...
        Returns:
            v0_5.datapoints.DatapointsResponse: A data object containing the requested data with several getter methods with different
            output formats.
        """
    ...
    def _split_TimeseriesWithDatapoints_if_over_limit(
        ...
        Args:
            timeseries_with_datapoints (v0_5.datapoints.TimeseriesWithDatapoints): The timeseries with data to potentially split up.

        Returns:
            A list of v0_5.datapoints.TimeSeriesWithDatapoints where each has a maximum number of datapoints equal to the limit given.
        """
    ...
    def post_multi_tag_datapoints(self, timeseries_with_datapoints: List[TimeseriesWithDatapoints], **kwargs) -> Dict:
        ...
        Args:
            timeseries_with_datapoints (List[v0_5.datapoints.TimeseriesWithDatapoints]): The timeseries with data to insert.
    ...
    def post_datapoints(self, name, datapoints: List[Datapoint], **kwargs) -> Dict:
        ...
        Args:
            ...
            datapoints (list[v0_5.datapoints.Datapoint): List of datapoint data transfer objects to insert.
    ...
    def get_latest(self, name, before=None, **kwargs) -> LatestDatapointResponse:
        ...
        Returns:
            v0_5.datapoints.LatestDatapointsResponse: A data object containing the requested data with several getter methods with different
            output formats.
        """
    ...
    def get_multi_time_series_datapoints(
        ...
        Args:
            datapoints_queries (list[v0_5.datapoints.DatapointsQuery]): The list of DatapointsQuery objects specifying which
        ...
        Returns:
            list(v0_5.datapoints.DatapointsResponse): A list of data objects containing the requested data with several getter methods
