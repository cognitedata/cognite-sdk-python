...
class TransformationDestination():
    ...
    def data_model_instances(model_external_id='', space_external_id='', instance_space_external_id=''):
        return DataModelInstances(model_external_id=model_external_id, space_external_id=space_external_id, instance_space_external_id=instance_space_external_id)

    @staticmethod
    def instances(view_external_id='', view_version='', view_space_external_id='', instance_space_external_id=''):
        return Instances(view_external_id=view_external_id, view_version=view_version, view_space_external_id=view_space_external_id, instance_space_external_id=instance_space_external_id)
...
class DataModelInstances(TransformationDestination):
    ...
    def __init__(self, model_external_id=None, space_external_id=None, instance_space_external_id=None):
        warnings.warn('Feature DataModelStorage is in beta and still in development. Breaking changes can happen in between patch versions.', stacklevel=2)
...
class Instances(TransformationDestination):
    ...
    def __init__(self, view_external_id=None, view_version=None, view_space_external_id=None, instance_space_external_id=None):
        warnings.warn('Feature DataModelStorage is in beta and still in development. Breaking changes can happen in between patch versions.', stacklevel=2)
    ...
    def __hash__(self):
        return hash((self.type, self.view_external_id, self.view_version, self.view_space_external_id, self.instance_space_external_id))

class OidcCredentials():

    def __init__(self, client_id=None, client_secret=None, scopes=None, token_uri=None, audience=None, cdf_project_name=None):
...
def _load_destination_dct(dct):
    ...
    try:
        dest_dct = {'raw': RawTable, 'data_model_instances': DataModelInstances, 'instances': Instances, 'sequence_rows': SequenceRows}
