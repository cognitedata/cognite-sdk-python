...
class TransformationJob(CogniteResource):
    ...
    def __init__(self, id=None, status=None, transformation_id=None, transformation_external_id=None, source_project=None, destination_project=None, destination=None, conflict_mode=None, query=None, error=None, ignore_null_fields=False, created_time=None, started_time=None, finished_time=None, last_seen_time=None, cognite_client=None):
        self.id = id
        self.status = status
    ...
    def wait(self, polling_interval=1, timeout=None):
        ...
        if (timeout is None):
            timeout = float('inf')
        waited = 0.0
        while ((waited < timeout) and (self.status not in [TransformationJobStatus.FAILED, TransformationJobStatus.COMPLETED])):
