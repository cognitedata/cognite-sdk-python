...
class TransformationNotification(CogniteResource):
    ...
    def __init__(self, id=None, transformation_id=None, transformation_external_id=None, destination=None, created_time=None, last_updated_time=None, cognite_client=None):
        self.id = id
