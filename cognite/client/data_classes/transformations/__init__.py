...
from cognite.client.data_classes._base import CogniteFilter, CogniteListUpdate, CognitePrimitiveUpdate, CognitePropertyClassUtil, CogniteResource, CogniteResourceList, CogniteUpdate
from cognite.client.data_classes.iam import ClientCredentials
from cognite.client.data_classes.shared import TimestampRange
from cognite.client.data_classes.transformations.common import DataModelInstances, NonceCredentials, OidcCredentials, RawTable, SequenceRows, TransformationBlockedInfo, TransformationDestination, _load_destination_dct
...
class Transformation(CogniteResource):
    ...
    def __init__(self, id=None, external_id=None, name=None, query=None, destination=None, conflict_mode=None, is_public=True, ignore_null_fields=False, source_api_key=None, destination_api_key=None, source_oidc_credentials=None, destination_oidc_credentials=None, created_time=None, last_updated_time=None, owner=None, owner_is_current_user=True, has_source_api_key=None, has_destination_api_key=None, has_source_oidc_credentials=None, has_destination_oidc_credentials=None, running_job=None, last_finished_job=None, blocked=None, schedule=None, data_set_id=None, cognite_client=None, source_nonce=None, destination_nonce=None, source_session=None, destination_session=None, tags=None):
        self.id = id
        ...
        self.has_destination_oidc_credentials = (has_destination_oidc_credentials or (destination_oidc_credentials is not None))
    ...
    def copy(self):
        return Transformation(self.id, self.external_id, self.name, self.query, self.destination, self.conflict_mode, self.is_public, self.ignore_null_fields, self.source_api_key, self.destination_api_key, self.source_oidc_credentials, self.destination_oidc_credentials, self.created_time, self.last_updated_time, self.owner, self.owner_is_current_user, self.has_source_api_key, self.has_destination_api_key, self.has_source_oidc_credentials, self.has_destination_oidc_credentials, self.running_job, self.last_finished_job, self.blocked, self.schedule, self.data_set_id, None, self.source_nonce, self.destination_nonce, self.source_session, self.destination_session, self.tags)
    ...
    def _process_credentials(self, sessions_cache=None, keep_none=False):
        ...
        def try_get_or_create_nonce(oidc_credentials: Optional[OidcCredentials]) -> Optional[NonceCredentials]:
            ...
            key = (f'{oidc_credentials.client_id}:{hash(oidc_credentials.client_secret)}' if oidc_credentials else 'DEFAULT')
    ...
    def dump(self, camel_case=False):
        ...
        for (name, prop) in ret.items():
            if isinstance(prop, (OidcCredentials, NonceCredentials, TransformationDestination, SessionDetails, TransformationSchedule)):
...
class TransformationFilter(CogniteFilter):
    ...
    def __init__(self, include_public=True, name_regex=None, query_regex=None, destination_type=None, conflict_mode=None, cdf_project_name=None, has_blocked_error=None, created_time=None, last_updated_time=None, data_set_ids=None, tags=None):
