...
class AgentToolUpsert(AgentToolCore, ABC):
    ...
    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> AgentToolUpsert:
        return cls(
            name=resource["name"],
...
class AgentTool(AgentToolCore, ABC):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> AgentTool:
        ...
        return tool_class._load_tool(resource)

    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> AgentTool:
...
class DataModelInfo(WriteableCogniteResource):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> DataModelInfo:
        return cls(
...
class InstanceSpaces(WriteableCogniteResource):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> InstanceSpaces:
        return cls(
            type=resource["type"],
...
class SummarizeDocumentAgentTool(AgentTool):
    ...
    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> SummarizeDocumentAgentTool:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class SummarizeDocumentAgentToolUpsert(AgentToolUpsert):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> SummarizeDocumentAgentToolUpsert:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class AskDocumentAgentTool(AgentTool):
    ...
    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> AskDocumentAgentTool:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class AskDocumentAgentToolUpsert(AgentToolUpsert):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> AskDocumentAgentToolUpsert:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class QueryTimeSeriesDatapointsAgentTool(AgentTool):
    ...
    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> QueryTimeSeriesDatapointsAgentTool:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class QueryTimeSeriesDatapointsAgentToolUpsert(AgentToolUpsert):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> QueryTimeSeriesDatapointsAgentToolUpsert:
        return cls(
            name=resource["name"],
            description=resource["description"],
        )
...
class UnknownAgentTool(AgentTool):
    ...
    @classmethod
    def _load_tool(cls, resource: dict[str, Any]) -> UnknownAgentTool:
        return cls(
            name=resource["name"],
            type=resource["type"],
            description=resource["description"],
...
class UnknownAgentToolUpsert(AgentToolUpsert):
    ...
    @classmethod
    def _load(cls, resource: dict[str, Any]) -> UnknownAgentToolUpsert:
        return cls(
            name=resource["name"],
            type=resource["type"],
            description=resource["description"],
