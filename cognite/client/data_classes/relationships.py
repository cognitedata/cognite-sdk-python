...
import copy
from cognite.client.data_classes._base import CogniteFilter, CogniteLabelUpdate, CognitePrimitiveUpdate, CogniteResource, CogniteResourceList, CogniteUpdate
...
class Relationship(CogniteResource):
    ...
    def __init__(self, external_id=None, source_external_id=None, source_type=None, source=None, target_external_id=None, target_type=None, target=None, start_time=None, end_time=None, confidence=None, data_set_id=None, labels=None, created_time=None, last_updated_time=None, cognite_client=None):
    ...
    def _convert_resource(self, resource, resource_type):
        resource_map: Dict[(str, Type[CogniteResource])] = {'timeSeries': TimeSeries, 'asset': Asset, 'sequence': Sequence, 'file': FileMetadata, 'event': Event}
...
class RelationshipFilter(CogniteFilter):
    ...
    def __init__(self, source_external_ids=None, source_types=None, target_external_ids=None, target_types=None, data_set_ids=None, start_time=None, end_time=None, confidence=None, last_updated_time=None, created_time=None, active_at_time=None, labels=None, cognite_client=None):
