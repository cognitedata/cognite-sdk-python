...
import json
from cognite.client.data_classes._base import CogniteFilter, CogniteObjectUpdate, CognitePrimitiveUpdate, CogniteResource, CogniteResourceList, CogniteUpdate
...
class Annotation(CogniteResource):
    ...
    def __init__(self, annotation_type, data, status, creating_app, creating_app_version, creating_user, annotated_resource_type, annotated_resource_id=None):
    ...
    def from_dict(cls, resource, cognite_client=None):
        ...
        annotation = Annotation(annotation_type=data['annotation_type'], data=data['data'], status=data.get('status', 'suggested'), creating_app=data['creating_app'], creating_app_version=data['creating_app_version'], creating_user=data.get('creating_user'), annotated_resource_type=data['annotated_resource_type'], annotated_resource_id=data.get('annotated_resource_id'))
...
class AnnotationFilter(CogniteFilter):
    ...
    def __init__(self, annotated_resource_type, annotated_resource_ids, status=None, creating_user='', creating_app=None, creating_app_version=None, annotation_type=None, data=None):
        self.annotated_resource_type = annotated_resource_type
