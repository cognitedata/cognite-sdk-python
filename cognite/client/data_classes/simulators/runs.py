...
class SimulationRun(SimulationRunCore):
    ...
    def get_logs(self) -> SimulatorLog | None:
        """`Retrieve logs for this simulation run. <https://api-docs.cognite.com/20230101/tag/Simulator-Logs/operation/simulator_logs_by_ids_simulators_logs_byids_post>`_
