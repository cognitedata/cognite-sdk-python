...
from cognite.client.data_classes._base import CogniteFilter, CognitePropertyClassUtil, CogniteResource, CogniteResourceList
...
class LabelDefinition(CogniteResource):
    ...
    def __init__(self, external_id=None, name=None, description=None, created_time=None, data_set_id=None, cognite_client=None):
