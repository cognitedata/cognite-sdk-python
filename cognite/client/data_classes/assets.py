...
from cognite.client.data_classes._base import CogniteFilter, CogniteLabelUpdate, CogniteListUpdate, CogniteObjectUpdate, CognitePrimitiveUpdate, CognitePropertyClassUtil, CogniteResource, CogniteResourceList, CogniteUpdate, T_CogniteResourceList
...
class Asset(CogniteResource):
    ...
    def __init__(self, external_id=None, name=None, parent_id=None, parent_external_id=None, description=None, data_set_id=None, metadata=None, source=None, labels=None, geo_location=None, id=None, created_time=None, last_updated_time=None, root_id=None, aggregates=None, cognite_client=None):
...
class AssetList(CogniteResourceList):
    ...
    def _retrieve_related_resources(self, resource_list_class, resource_api):
        ...
        res_list = utils._concurrency.execute_tasks(retrieve_and_deduplicate, tasks, resource_api._config.max_workers).results
        resources = resource_list_class([])
        for res in res_list:
...
class AssetFilter(CogniteFilter):
    ...
    def __init__(self, name=None, parent_ids=None, parent_external_ids=None, asset_subtree_ids=None, data_set_ids=None, metadata=None, source=None, created_time=None, last_updated_time=None, root=None, external_id_prefix=None, labels=None, geo_location=None, cognite_client=None):
        self.name = name
