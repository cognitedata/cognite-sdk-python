...
class TimeSeries(CogniteResource):
    ...
    def __init__(self, id=None, external_id=None, name=None, is_string=None, metadata=None, unit=None, asset_id=None, is_step=None, description=None, security_categories=None, data_set_id=None, created_time=None, last_updated_time=None, legacy_name=None, cognite_client=None):
        self.id = id
    ...
    def count(self):
        ...
        dps = self._cognite_client.time_series.data.retrieve(**identifier, start=MIN_TIMESTAMP_MS, end=(MAX_TIMESTAMP_MS + 1), aggregates='count', granularity='100d')
    ...
    def first(self):
        identifier = Identifier.load(self.id, self.external_id).as_dict()
        dps = self._cognite_client.time_series.data.retrieve(**identifier, start=MIN_TIMESTAMP_MS, end=(MAX_TIMESTAMP_MS + 1), limit=1)
        if dps:
            return dps[0]
        return None
...
class TimeSeriesFilter(CogniteFilter):
    ...
    def __init__(self, name=None, unit=None, is_string=None, is_step=None, metadata=None, asset_ids=None, asset_external_ids=None, asset_subtree_ids=None, data_set_ids=None, external_id_prefix=None, created_time=None, last_updated_time=None, cognite_client=None):
        self.name = name
        self.unit = unit
        self.is_string = is_string
        self.is_step = is_step
