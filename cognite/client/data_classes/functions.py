...
RunTime: TypeAlias = Literal["py311", "py312", "py313"]
...
class FunctionCore(WriteableCogniteResourceWithClientRef["FunctionWrite"], ABC):
    ...
    Args:
        ...
        runtime (RunTime | None): Runtime of the function. Allowed values are ["py311", "py312", "py313"]. The runtime "py313" resolves to the latest version of the Python 3.13 series.
