...
class SequencesClientV0_6(APIClient):
    def post_sequences(self, sequences: List[Sequence]) -> Sequence:
        """Create a new time series.

        Args:
            sequences (list[v0_6.dto.Sequence]):  List of sequence data transfer objects to create.

        Returns:
            client.v0_6.sequences.Sequence: The created sequence
        """
        url = "/sequences"
    ...
    def get_sequence_by_id(self, id: int) -> Sequence:
        ...
        Returns:
            client.v0_6.sequences.Sequence: A data object containing the requested sequence.
        """
    ...
    def get_sequence_by_external_id(self, external_id: str) -> Sequence:
        ...
        Returns:
            v0_6.dto.Sequence: A data object containing the requested sequence.
        """
        url = "/sequences"
    ...
    def get_data_from_sequence(
        ...
        Returns:
            client.v0_6.sequences.SequenceDataResponse: A data object containing the requested sequence.
        """
