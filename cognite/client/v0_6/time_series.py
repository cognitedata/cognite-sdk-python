...
from cognite.client.v0_6 import CogniteResponse
...
class TimeSeriesClientV0_6(APIClient):
    def get_time_series_by_id(self, id: int, include_metadata: bool = False) -> TimeSeriesResponse:
        ...
        Returns:
            client.v0_6.time_series.TimeSeriesResponse: A data object containing the requested timeseries.
        """
    ...
    def get_multiple_time_series_by_id(self, ids: List[int], include_metadata: bool = False) -> TimeSeriesResponse:
        ...
        Returns:
            client.v0_6.time_series.TimeSeriesResponse: A data object containing the requested timeseries with several
    ...
    def search_for_time_series(
        ...
        **kwargs
        ...
        Returns:
            client.v0_6.time_series.TimeSeriesResponse: A data object containing the requested timeseries with several getter methods with different
            output formats.
        """
