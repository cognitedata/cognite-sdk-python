...
class DatapointsClientV0_6(APIClient):
    def get_datapoints(self, id, start, end=None, aggregates=None, granularity=None, **kwargs) -> DatapointsResponse:
        ...
        Returns:
            client.v0_6.datapoints.DatapointsResponse: A data object containing the requested data with several getter methods with different
            output formats.
        """
