...
class AsyncTemplatesAPI(AsyncAPIClient):
    ...
    async def list(self, limit: int | None = DEFAULT_LIMIT_READ, **kwargs) -> dict:
        """`List templates <placeholder-api-docs>`_"""
    ...
    async def retrieve(self, id: int | None = None, external_id: str | None = None):
        """`Retrieve a single templates by id.`_"""
        # Placeholder implementation
        pass

    async def create(self, item):
        """`Create one or more templates.`_"""
        # Placeholder implementation  
        pass

    async def delete(self, id: int | Sequence[int] | None = None, external_id: str | None = None):
        """`Delete one or more templates`_"""
        # Placeholder implementation
        pass

    async def update(self, item):
        """`Update one or more templates`_"""
        # Placeholder implementation
        pass
