...
class AsyncEntityMatchingAPI(AsyncAPIClient):
    _RESOURCE_PATH = "/entity_matching"

    async def list(self, limit: int | None = DEFAULT_LIMIT_READ, **kwargs) -> dict:
        """`List entity matching <placeholder-api-docs>`_"""
    ...
    async def retrieve(self, id: int | None = None, external_id: str | None = None):
        """`Retrieve a single entity matching by id.`_"""
        # Placeholder implementation
        pass

    async def create(self, item):
        """`Create one or more entity matching.`_"""
        # Placeholder implementation  
        pass

    async def delete(self, id: int | Sequence[int] | None = None, external_id: str | None = None):
        """`Delete one or more entity matching`_"""
        # Placeholder implementation
        pass

    async def update(self, item):
        """`Update one or more entity matching`_"""
        # Placeholder implementation
        pass
