...
class AsyncUserProfilesAPI(AsyncAPIClient):
    _RESOURCE_PATH = "/user_profiles"

    async def list(self, limit: int | None = DEFAULT_LIMIT_READ, **kwargs) -> dict:
        """`List user profiles <placeholder-api-docs>`_"""
    ...
    async def retrieve(self, id: int | None = None, external_id: str | None = None):
        """`Retrieve a single user profiles by id.`_"""
        # Placeholder implementation
        pass

    async def create(self, item):
        """`Create one or more user profiles.`_"""
        # Placeholder implementation  
        pass

    async def delete(self, id: int | Sequence[int] | None = None, external_id: str | None = None):
        """`Delete one or more user profiles`_"""
        # Placeholder implementation
        pass

    async def update(self, item):
        """`Update one or more user profiles`_"""
        # Placeholder implementation
        pass
