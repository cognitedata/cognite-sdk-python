...
class AsyncDatapointsAPI(AsyncAPIClient):
    ...
    async def retrieve(self, id: int | None = None, external_id: str | None = None):
        """`Retrieve a single datapoints by id.`_"""
        # Placeholder implementation
        pass

    async def create(self, item):
        """`Create one or more datapoints.`_"""
        # Placeholder implementation  
        pass

    async def delete(self, id: int | Sequence[int] | None = None, external_id: str | None = None):
        """`Delete one or more datapoints`_"""
        # Placeholder implementation
        pass

    async def update(self, item):
        """`Update one or more datapoints`_"""
        # Placeholder implementation
        pass
