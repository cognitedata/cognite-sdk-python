...
class AsyncWorkflowsAPI(AsyncAPIClient):
    ...
    async def retrieve(self, id: int | None = None, external_id: str | None = None):
        """`Retrieve a single workflows by id.`_"""
        # Placeholder implementation
        pass

    async def create(self, item):
        """`Create one or more workflows.`_"""
        # Placeholder implementation  
        pass

    async def delete(self, id: int | Sequence[int] | None = None, external_id: str | None = None):
        """`Delete one or more workflows`_"""
        # Placeholder implementation
        pass

    async def update(self, item):
        """`Update one or more workflows`_"""
        # Placeholder implementation
        pass
