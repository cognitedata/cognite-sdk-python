...
## [7.90.0](https://github.com/cognitedata/cognite-sdk-python/compare/v7.89.0...v7.90.0) (2025-11-12)

### Features

* **workflows:** Allow `failed_with_terminal_error` status for workflow task updates
