...
@pytest.fixture
def cap_with_extra_key() -> dict[str, Any]:
    return {
...
@pytest.fixture
def unknown_cap_with_extra_key() -> dict[str, Any]:
    return {
        "extra-key": {"urlNames": ["my-sandbox"]},
...
class TestCapabilities:
    ...
    def test_load_dump__extra_top_level_keys(self, cap_with_extra_key: dict[str, Any]) -> None:
    ...
    def test_load_dump_unknown__extra_top_level_keys(self, unknown_cap_with_extra_key: dict[str, Any]) -> None:
        match = (
    ...
    def test_load_capability_misspelled_acl(self, unknown_acls_items: list[dict[str, Any]]) -> None:
...
@pytest.fixture
def proj_cap_allprojects_dct() -> dict[str, Any]:
...
@pytest.fixture
def unknown_acls_items() -> list[dict[str, Any]]:
    return [
        # Unknown capability:
...
class TestCogniteClientDoesntRaiseOnUnknownAcls:
    def test_groups_list(
        self, cognite_client: CogniteClient, mock_groups_resp: HTTPXMock, unknown_acls_items: list[dict[str, Any]]
    ) -> None:
    ...
    def test_token_inspect(self, cognite_client: CogniteClient, mock_token_inspect_resp: HTTPXMock) -> None:
...
class TestProjectCapabilityList:
    def test_project_scope_is_all_projects(self, proj_cap_allprojects_dct: dict[str, Any]) -> None:
...
class TestIAMCompareCapabilities:
    ...
    def test_raw_acl_database_scope(self, cognite_client: CogniteClient, extra_existing: list[RawAcl]) -> None:
        existing: list[RawAcl] = [
...
def test_idscopes_lower_case(dct: dict[str, Any]) -> None:
