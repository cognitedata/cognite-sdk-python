...
@pytest.fixture
def unknown_schema(struct_schema: dict) -> dict:
    return {
...
def test_transformation_schema_column__struct(struct_schema: dict) -> None:
...
def test_transformation_schema_column__unknown_schema(unknown_schema: dict) -> None:
