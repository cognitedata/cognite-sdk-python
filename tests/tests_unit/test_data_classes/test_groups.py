...
class TestGroups:
    def test_group_init__accept_single_acl(self) -> None:
        ...
        assert Group(
            name="a", capabilities=acl, id=1, source_id="bla", is_deleted=False, deleted_time=None, attributes=None
        ) == Group(
            name="a", capabilities=[acl], id=1, source_id="bla", is_deleted=False, deleted_time=None, attributes=None
        )
    ...
    def test_load_dump__cdf_managed_groups(self, group_with_members: dict, group_with_all_members: dict) -> None:
...
class TestGroupsList:
    ...
    def test_to_pandas__deleted_time(self, expected: dict, convert_timestamps: bool) -> None:
        import pandas as pd
