...
class TestWorkflowTaskOutput:
    ...
    def test_serialization(self, output: WorkflowTaskOutput, expected: dict) -> None:
...
class TestWorkflowExecutionDetailed:
    ...
    def test_dump(self, execution_data: dict) -> None:
    ...
    def test_load(self, execution_data: dict) -> None:
        wf_execution = WorkflowExecutionDetailed.load(execution_data)
    ...
    def test_definition_parsed_correctly(self, execution_data: dict) -> None:
        wf_execution = WorkflowExecutionDetailed.load(execution_data)
    ...
    def test_executed_tasks_parsed_correctly(self, execution_data: dict) -> None:
        wf_execution = WorkflowExecutionDetailed.load(execution_data)
...
class TestWorkflowTask:
    ...
    def test_serialization(self, raw: dict) -> None:
