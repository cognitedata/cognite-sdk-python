...
class TestCogniteObject:
    ...
    def test_yaml_serialize(
        ...
        instance = FakeCogniteResourceGenerator(
            seed=65, cognite_client=cognite_async_mock_client_placeholder
...
class TestCogniteResource:
    ...
    def test_json_serialize(
        ...
        instance = FakeCogniteResourceGenerator(
            seed=42, cognite_client=cognite_async_mock_client_placeholder
    ...
    def test_yaml_serialize(
        ...
        instance = FakeCogniteResourceGenerator(
            seed=64, cognite_client=cognite_async_mock_client_placeholder
        ).create_instance(cognite_resource_subclass)
