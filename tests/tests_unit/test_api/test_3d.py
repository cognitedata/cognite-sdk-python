...
class Test3DReveal:
    ...
    def test_list_nodes(self, mock_list_reveal_nodes_response):
        ...
        assert mock_list_reveal_nodes_response.calls[0].response.json()["items"] == res.dump(camel_case=True)
    ...
    def test_list_sectors(self, mock_list_reveal_sectors_response):
        ...
        assert mock_list_reveal_sectors_response.calls[0].response.json()["items"] == res.dump(camel_case=True)
