...
from cognite.client.data_classes.agents.agent_tools import AgentToolApply
...
class TestAgentsAPIUnit:
    ...
    def test_apply_minimal(self, cognite_client: CogniteClient, mock_agent_apply_response: MagicMock) -> None:
        agent_write = AgentApply(external_id="agent_1", name="Agent 1")
    ...
    def test_apply_full(self, cognite_client: CogniteClient, mock_agent_apply_response: MagicMock) -> None:
        agent_write = AgentApply(
            external_id="agent_1",
            name="Agent 1",
            description="Description 1",
            instructions="Instructions 1",
            ...
            tools=[
                AgentToolApply(
                    ...
                    configuration={
                        "dataModels": [
                            {"space": "space1", "externalId": "dmxid1", "version": "v1", "viewExternalIds": ["view1"]}
                        ],
                        "instanceSpaces": {"type": "all"},
                    },
                )
