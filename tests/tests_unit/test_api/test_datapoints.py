...
class TestDatapointsObject:
    ...
    def test_eq(self) -> None:
        assert Datapoints(1, is_string=False, is_step=False, type="numeric") == Datapoints(
            1, is_string=False, is_step=False, type="numeric"
        )
        assert Datapoints(
            1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], value=[1.0, 2.0, 3.0]
        ) == Datapoints(1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], value=[1.0, 2.0, 3.0])
        assert Datapoints(1, is_string=False, is_step=False, type="numeric") != Datapoints(
            0, is_string=False, is_step=False, type="numeric"
        )
        assert Datapoints(
            1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], value=[1.0, 2.0, 3.0]
        ) != Datapoints(1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], max=[1.0, 2.0, 3.0])
        assert Datapoints(
            1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], value=[1.0, 2.0, 3.0]
        ) != Datapoints(1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2, 3], value=[1.0, 2.0, 4.0])
    ...
    def test_get_item(self) -> None:
        ...
        assert (
            Datapoints(id=1, is_string=False, is_step=False, type="numeric", timestamp=[1, 2], value=[1.0, 2.0])
            == dps[:2]
        )
