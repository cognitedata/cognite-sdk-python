...
class TestLabels:
    def test_list(self, cognite_client, mock_labels_response, httpx_mock):
    ...
    def test_call(self, cognite_client, mock_labels_response, httpx_mock):
        list(cognite_client.labels(limit=10))
        calls = httpx_mock.get_requests()
        assert 1 == len(calls)
        assert {"limit": 10} == jsgz_load(calls[0].content)

    def test_create_single(self, cognite_client, mock_labels_response, httpx_mock):
    ...
    def test_create_multiple(self, cognite_client, mock_labels_response, httpx_mock):
    ...
    def test_delete_single(self, cognite_client, mock_labels_response, httpx_mock):
    ...
    def test_delete_multiple(self, cognite_client, mock_labels_response, httpx_mock):
    ...
    def test_list_with_dataset_ids(self, cognite_client, mock_labels_response, httpx_mock):
