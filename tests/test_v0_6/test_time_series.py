...
from cognite.client.v0_6.time_series import TimeSeriesClientV0_6, TimeSeriesResponse
from tests.conftest import TEST_TS_1_NAME

time_series = CogniteClient().client_factory(client=TimeSeriesClientV0_6)
