...
from cognite.client.v0_5.timeseries import TimeSeries
from cognite.client.v0_6.datapoints import DatapointsClientV0_6, DatapointsResponse
from tests.conftest import TEST_TS_REASONABLE_INTERVAL, TEST_TS_REASONABLE_INTERVAL_DATETIME

cognite_client = CogniteClient()
datapoints = cognite_client.client_factory(client=DatapointsClientV0_6)
