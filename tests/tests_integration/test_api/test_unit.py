...
class TestFromAlias:
    ...
    def test_lookup_unit_from_alias(self, cognite_client, alias, quantity, expected_xid) -> None:
        unit = cognite_client.units.from_alias(alias, quantity)
        assert unit.external_id == expected_xid

    def test_lookup_unit_from_alias_unknown_quantity(self, cognite_client) -> None:
    ...
    def test_lookup_ambiguous(self, cognite_client) -> None:
    ...
    def test_lookup_closest_match__only_alias(self, cognite_client) -> None:
    ...
    def test_lookup_closest_match_alias_and_quantity(self, cognite_client) -> None:
        # Ensure it fails without 'closest matches':
