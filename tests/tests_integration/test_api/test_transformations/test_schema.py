...
class TestTransformationSchemaAPI:
    ...
    def test_nodes_with_view(self, cognite_client):
        nodes_columns = cognite_client.transformations.schema.retrieve(destination=TransformationDestination.nodes(
            view=ViewInfo(
    ...
    def test_edges_with_view(self, cognite_client):
        edges_columns = cognite_client.transformations.schema.retrieve(destination=TransformationDestination.edges(
            view=ViewInfo(
                space="test-space", external_id="testInstanceViewExternalId", version="testInstanceViewVersion"
            ),
            instance_space="test-space"
    ...
    def test_instance_type_data_model(self, cognite_client):
        type_columns = cognite_client.transformations.schema.retrieve(destination=TransformationDestination.instances(
